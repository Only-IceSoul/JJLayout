...
//endregion
    ...
    fun colGravity(gravity: Int): JJFrameLayout {
        setupCol()
    ...
    fun ablScrollFlags(flags: Int) : JJFrameLayout {
        setupAblp()
        (layoutParams as? AppBarLayout.LayoutParams)?.scrollFlags = flags
        return this
    }

    fun ablScrollInterpolator(interpolator: Interpolator) : JJFrameLayout {
        setupAblp()
    ...
    fun rlAlignParentTop(value : Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentStart(value : Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentEnd(value : Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentLeft(value : Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentRight(value : Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentVertically(value:Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentHorizontally(value:Boolean = true): JJFrameLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignBaseline(viewId: Int): JJFrameLayout {
        setupRlp()
    ...
    fun llWeight(w: Float): JJFrameLayout {
        setupLlp()
