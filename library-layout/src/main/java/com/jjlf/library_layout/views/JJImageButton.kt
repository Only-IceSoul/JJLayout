...
//endregion
    ...
    fun ssIdentifier(value: Int): JJImageButton {
        mIdentifier = value
        return this
    }
    ...
    fun ssState(state: Int): JJImageButton {
        mState = state
        return this
    }
    ...
    fun ssAttribute(string:String): JJImageButton {
        mAttribute = string
        return this
    }
    ...
    fun ssBackgroundAlpha(value: Int): JJImageButton {
        background.alpha = value
        return this
    }

    fun ssAlpha(value: Float) : JJImageButton {
        alpha =  value
        return this
    }

    fun ssVisibility(type: Int) : JJImageButton {
        visibility  =  type
        return this
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    fun ssElevation(value: Float) : JJImageButton {
        elevation =  value
        return this
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    fun ssOutlineProvider(provider: ViewOutlineProvider): JJImageButton {
        outlineProvider = provider
        return this
    }
    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    fun ssClipToOutline(boolean: Boolean): JJImageButton {
        clipToOutline = boolean
        return this
    }

    fun ssImageDrawable(drawable: Drawable?) : JJImageButton {
        setImageDrawable(drawable)
        return this
    }

    fun ssImageBitmap(bitmap: Bitmap) : JJImageButton {
        setImageBitmap(bitmap)
        return this
    }

    fun ssImageURI(uri: Uri) : JJImageButton {
        setImageURI(uri)
        return this
    }

    fun ssImageResoruce(id: Int) : JJImageButton {
        setImageResource(id)
        return this
    }

    fun ssImageState(state: IntArray,merge: Boolean) : JJImageButton {
        setImageState(state,merge)
        return this
    }


    fun ssScaleType(scaleType: ScaleType): JJImageButton {
        setScaleType(scaleType)
        return this
    }

    fun ssBackgroundColor(color: Int): JJImageButton {
        setBackgroundColor(color)
        return this
    }

    fun ssBackground(drawable: Drawable?): JJImageButton {
        background = drawable
        return this
    }

    fun ssPadding(padding: JJPadding): JJImageButton {
        mlpPadding = padding
        setPaddingRelative(padding.left,padding.top,padding.right,padding.bottom)
        return this
    }

    fun ssOnClickListener(listener: OnClickListener): JJImageButton {
        setOnClickListener(listener)
        return this
    }

    fun ssOnTouchListener(listener: (View, MotionEvent) -> Boolean): JJImageButton {
        setOnTouchListener(listener)
        return this
    }


    fun ssMinimumHeight(h:Int): JJImageButton {
        minimumHeight = h
        return this
    }

    fun ssMinimumWidth(w:Int): JJImageButton {
        minimumWidth = w
        return this
    }
    ...
    fun ssClipChildrenToPath(path: Path): JJImageButton {
    ...
    fun ssClipAllToPath(path: Path): JJImageButton {
        mPathClipAll = path
    ...
    fun ssClipOutChildrenToPath(path: Path): JJImageButton {
        mPathClipChildren = path
        mIsPathClosureClipChildren = false
    ...
    fun ssClipOutAllToPath(path: Path): JJImageButton {
        mPathClipAll = path
        mIsPathClosureClipAll = false
    ...
    fun ssClipChildrenToPath(closure:(RectF, Path)->Unit): JJImageButton {
        mIsClipInPathChildren = true
    ...
    fun ssClipAllToPath(closure:(RectF, Path, JJPadding)->Unit): JJImageButton {
        mIsClipInPathAll = true
    ...
    fun ssClipOutChildrenToPath(closure:(RectF, Path)->Unit): JJImageButton {
        mIsClipInPathChildren = false
        mIsPathClosureClipChildren = true
        mIsClipOutPathChildren = true
        mIsClipChildrenEnabled = true
    ...
    fun ssClipOutAllToPath(closure:(RectF, Path, JJPadding)->Unit): JJImageButton {
        mIsClipInPathAll = false
        mIsPathClosureClipAll = true
        mIsClipOutPathAll = true
        mIsClipAllEnabled = true
    ...
    fun disposeClipPathChildren(): JJImageButton {
        mIsClipOutPathChildren = false
        mIsPathClosureClipChildren = false
    ...
    fun disposeClipPathAll(): JJImageButton {
        mIsClipOutPathAll = false
        mIsPathClosureClipAll = false
    ...
    fun colGravity(gravity: Int): JJImageButton {
        setupCol()
    ...
    fun ablScrollFlags(flags: Int) : JJImageButton {
        setupAblp()
        (layoutParams as? AppBarLayout.LayoutParams)?.scrollFlags = flags
        return this
    }

    fun ablScrollInterpolator(interpolator: Interpolator) : JJImageButton {
        setupAblp()
    ...
    fun rlAlignParentTop(value : Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentStart(value : Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentEnd(value : Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentLeft(value : Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentRight(value : Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentVertically(value:Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentHorizontally(value:Boolean = true): JJImageButton {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignBaseline(viewId: Int): JJImageButton {
        setupRlp()
    ...
    fun llWeight(w: Float): JJImageButton {
        setupLlp()
        (layoutParams as? LinearLayout.LayoutParams)?.weight = w
        return this
    }
    fun llGravity(gravity: Int): JJImageButton {
        setupLlp()
    ...
    fun cllFloatCustomAttribute(attrName: String, value: Float): JJImageButton {
        mConstraintSet.setFloatValue(id,attrName,value)
        return this
    }

    fun cllIntCustomAttribute(attrName: String, value: Int): JJImageButton {
        mConstraintSet.setIntValue(id,attrName,value)
        return this
    }

    fun cllColorCustomAttribute(attrName: String, value: Int): JJImageButton {
        mConstraintSet.setColorValue(id,attrName,value)
        return this
    }

    fun cllStringCustomAttribute(attrName: String, value: String): JJImageButton {
        mConstraintSet.setStringValue(id,attrName,value)
        return this
    }

    fun cllRotation(float: Float): JJImageButton {
        mConstraintSet.setRotation(id,float)
        return this
    }

    fun cllRotationX(float: Float): JJImageButton {
        mConstraintSet.setRotationX(id,float)
        return this
    }

    fun cllRotationY(float: Float): JJImageButton {
        mConstraintSet.setRotationY(id,float)
        return this
    }

    fun cllTranslation(x: Float,y: Float): JJImageButton {
        mConstraintSet.setTranslation(id,x,y)
        return this
    }
    fun cllTranslationX(x: Float): JJImageButton {
        mConstraintSet.setTranslationX(id,x)
        return this
    }

    fun cllTranslationY(y: Float): JJImageButton {
        mConstraintSet.setTranslationY(id,y)
        return this
    }

    fun cllTranslationZ(z: Float): JJImageButton {
        mConstraintSet.setTranslationZ(id,z)
        return this
    }

    fun cllTransformPivot(x: Float, y: Float): JJImageButton {
        mConstraintSet.setTransformPivot(id,x,y)
        return this
    }

    fun cllTransformPivotX(x: Float): JJImageButton {
        mConstraintSet.setTransformPivotX(id,x)
        return this
    }

    fun cllTransformPivotY(y: Float): JJImageButton {
        mConstraintSet.setTransformPivotY(id,y)
        return this
    }

    fun cllScaleX(x: Float): JJImageButton {
        mConstraintSet.setScaleX(id,x)
        return this
    }

    fun cllScaleY(y: Float): JJImageButton {
        mConstraintSet.setScaleY(id,y)
        return this
    }

    fun cllDimensionRatio(ratio: String): JJImageButton {
        mConstraintSet.setDimensionRatio(id,ratio)
        return this
    }

    fun cllAlpha(alpha: Float): JJImageButton {
        mConstraintSet.setAlpha(id,alpha)
        return this
    }


    fun cllApply(): JJImageButton {
        mConstraintSetLandScape.applyTo(parent as ConstraintLayout)
        return this
    }

    fun cllVisibilityMode(visibility: Int): JJImageButton {
        mConstraintSetLandScape.setVisibilityMode(id, visibility)
        return this
    }

    fun cllVerticalBias(float: Float): JJImageButton {
        mConstraintSetLandScape.setVerticalBias(id,float)
        return this
    }
    fun cllHorizontalBias(float: Float): JJImageButton {
        mConstraintSetLandScape.setHorizontalBias(id,float)
        return this
    }

    fun cllCenterHorizontallyOf(viewId: Int, marginStart: Int = 0, marginEnd: Int = 0): JJImageButton {
    ...
    fun cllCenterVerticallyOf(viewId: Int,marginTop: Int = 0, marginBottom: Int = 0): JJImageButton {
    ...
    fun cllMargins(margins: JJMargin) : JJImageButton {
    ...
    fun cllCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJImageButton {
    ...
    fun cllCenterInParentVertically(): JJImageButton {
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mConstraintSetLandScape.setVerticalBias(id, 0.5f)
        return this
    ...
    fun cllCenterInParentHorizontally(): JJImageButton {
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mConstraintSetLandScape.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun cllCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJImageButton {
    ...
    fun cllCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJImageButton {
    ...
    fun cllCenterInParentTopVertically(): JJImageButton {
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun cllCenterInParentBottomVertically(): JJImageButton {
    ...
    fun cllCenterInParentStartHorizontally(): JJImageButton {
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun cllCenterInParentEndHorizontally(): JJImageButton {
    ...
    fun cllCenterInTopVertically(topId: Int): JJImageButton {
    ...
    fun cllCenterInBottomVertically(bottomId: Int): JJImageButton {
    ...
    fun cllCenterInStartHorizontally(startId: Int): JJImageButton {
    ...
    fun cllCenterInEndHorizontally(endId: Int): JJImageButton {
    ...
    fun cllCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJImageButton {
        mConstraintSetLandScape.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun cllCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJImageButton {
        mConstraintSetLandScape.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun cllFillParent(): JJImageButton {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun cllFillParent(margin: JJMargin): JJImageButton {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun cllFillParentHorizontally(): JJImageButton {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun cllFillParentVertically(): JJImageButton {
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun cllFillParentHorizontally(startMargin: Int, endMargin: Int): JJImageButton {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun cllFillParentVertically(topMargin: Int, bottomMargin: Int): JJImageButton {
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun cllVisibility(visibility: Int): JJImageButton {
    ...
    fun cllElevation(elevation: Float): JJImageButton {
    ...
    fun cllMinWidth(w:Int): JJImageButton {
        mConstraintSetLandScape.constrainMinWidth(id,w)
        return this
    }

    fun cllMinHeight(h:Int): JJImageButton {
        mConstraintSetLandScape.constrainMinHeight(id,h)
        return this
    }

    fun cllMaxWidth(w:Int): JJImageButton {
        mConstraintSetLandScape.constrainMaxWidth(id,w)
        return this
    }

    fun cllMaxHeight(h:Int): JJImageButton {
...
//endregion
    ...
    fun mlVisibilityMode(visibility: Int): JJImageButton {
        mMotionConstraintSet?.setVisibilityMode(id, visibility)
        return this
    }

    fun mlVerticalBias(float: Float): JJImageButton {
        mMotionConstraintSet?.setVerticalBias(id,float)
        return this
    }
    fun mlHorizontalBias(float: Float): JJImageButton {
        mMotionConstraintSet?.setHorizontalBias(id,float)
        return this
    }

    fun mlCenterHorizontallyOf(viewId: Int, marginStart: Int = 0, marginEnd: Int = 0): JJImageButton {
    ...
    fun mlCenterVerticallyOf(viewId: Int,marginTop: Int = 0, marginBottom: Int = 0): JJImageButton {
    ...
    fun mlMargins(margins: JJMargin) : JJImageButton {
    ...
    fun mlFloatCustomAttribute(attrName: String, value: Float): JJImageButton {
        mMotionConstraintSet?.setFloatValue(id,attrName,value)
        return this
    }

    fun mlIntCustomAttribute(attrName: String, value: Int): JJImageButton {
        mMotionConstraintSet?.setIntValue(id,attrName,value)
        return this
    }

    fun mlColorCustomAttribute(attrName: String, value: Int): JJImageButton {
        mMotionConstraintSet?.setColorValue(id,attrName,value)
        return this
    }

    fun mlStringCustomAttribute(attrName: String, value: String): JJImageButton {
        mMotionConstraintSet?.setStringValue(id,attrName,value)
        return this
    }

    fun mlRotation(float: Float): JJImageButton {
        mMotionConstraintSet?.setRotation(id,float)
        return this
    }

    fun mlRotationX(float: Float): JJImageButton {
        mMotionConstraintSet?.setRotationX(id,float)
        return this
    }

    fun mlRotationY(float: Float): JJImageButton {
        mMotionConstraintSet?.setRotationY(id,float)
        return this
    }

    fun mlTranslation(x: Float,y: Float): JJImageButton {
        mMotionConstraintSet?.setTranslation(id,x,y)
        return this
    }
    fun mlTranslationX(x: Float): JJImageButton {
        mMotionConstraintSet?.setTranslationX(id,x)
        return this
    }

    fun mlTranslationY(y: Float): JJImageButton {
        mMotionConstraintSet?.setTranslationY(id,y)
        return this
    }

    fun mlTranslationZ(z: Float): JJImageButton {
        mMotionConstraintSet?.setTranslationZ(id,z)
        return this
    }

    fun mlTransformPivot(x: Float, y: Float): JJImageButton {
        mMotionConstraintSet?.setTransformPivot(id,x,y)
        return this
    }

    fun mlTransformPivotX(x: Float): JJImageButton {
        mMotionConstraintSet?.setTransformPivotX(id,x)
        return this
    }

    fun mlTransformPivotY(y: Float): JJImageButton {
        mMotionConstraintSet?.setTransformPivotY(id,y)
        return this
    }

    fun mlScaleX(x: Float): JJImageButton {
        mMotionConstraintSet?.setScaleX(id,x)
        return this
    }

    fun mlScaleY(y: Float): JJImageButton {
        mMotionConstraintSet?.setScaleY(id,y)
        return this
    }

    fun mlDimensionRatio(ratio: String): JJImageButton {
        mMotionConstraintSet?.setDimensionRatio(id,ratio)
        return this
    }

    fun mlAlpha(alpha: Float): JJImageButton {
    ...
    fun mlCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJImageButton {
    ...
    fun mlCenterInParentVertically(): JJImageButton {
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mMotionConstraintSet?.setVerticalBias(id, 0.5f)
    ...
    fun mlCenterInParentHorizontally(): JJImageButton {
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mMotionConstraintSet?.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun mlCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJImageButton {
    ...
    fun mlCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJImageButton {
    ...
    fun mlCenterInParentTopVertically(): JJImageButton {
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun mlCenterInParentBottomVertically(): JJImageButton {
    ...
    fun mlCenterInParentStartHorizontally(): JJImageButton {
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun mlCenterInParentEndHorizontally(): JJImageButton {
    ...
    fun mlCenterInTopVerticallyOf(viewId: Int): JJImageButton {
    ...
    fun mlCenterInBottomVerticallyOf(viewId: Int): JJImageButton {
    ...
    fun mlCenterInStartHorizontallyOf(viewId: Int): JJImageButton {
    ...
    fun mlCenterInEndHorizontallyOf(viewId: Int): JJImageButton {
    ...
    fun mlCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJImageButton {
        mMotionConstraintSet?.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun mlCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJImageButton {
        mMotionConstraintSet?.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun mlFillParent(): JJImageButton {
    ...
    fun mlFillParent(margin: JJMargin): JJImageButton {
        mMotionConstraintSet?.constrainWidth(id,0)
        mMotionConstraintSet?.constrainHeight(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun mlFillParentHorizontally(): JJImageButton {
        mMotionConstraintSet?.constrainWidth(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun mlFillParentVertically(): JJImageButton {
        mMotionConstraintSet?.constrainHeight(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mMotionConstraintSet?.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun mlFillParentHorizontally(startMargin: Int, endMargin: Int): JJImageButton {
        mMotionConstraintSet?.constrainWidth(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun mlFillParentVertically(topMargin: Int, bottomMargin: Int): JJImageButton {
        mMotionConstraintSet?.constrainHeight(id,0)
        mMotionConstraintSet?.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mMotionConstraintSet?.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun mlVisibility(visibility: Int): JJImageButton {
        mMotionConstraintSet?.setVisibility(id, visibility)
        return this
    }

    fun mlElevation(elevation: Float): JJImageButton {
        mMotionConstraintSet?.setElevation(id, elevation)
        return this
    }

    fun mlApply(): JJImageButton {
        mMotionConstraintSet?.applyTo(parent as ConstraintLayout)
        return this
    }

    fun mlSetConstraint(cs : ConstraintSet?): JJImageButton {
        mMotionConstraintSet = cs
        return this
    }

    fun mlDisposeConstraint(): JJImageButton {
    ...
    fun clFloatCustomAttribute(attrName: String, value: Float): JJImageButton {
        mConstraintSet.setFloatValue(id,attrName,value)
        return this
    }

    fun clIntCustomAttribute(attrName: String, value: Int): JJImageButton {
        mConstraintSet.setIntValue(id,attrName,value)
        return this
    }

    fun clColorCustomAttribute(attrName: String, value: Int): JJImageButton {
        mConstraintSet.setColorValue(id,attrName,value)
        return this
    }

    fun clStringCustomAttribute(attrName: String, value: String): JJImageButton {
        mConstraintSet.setStringValue(id,attrName,value)
        return this
    }

    fun clRotation(float: Float): JJImageButton {
        mConstraintSet.setRotation(id,float)
        return this
    }

    fun clRotationX(float: Float): JJImageButton {
        mConstraintSet.setRotationX(id,float)
        return this
    }

    fun clRotationY(float: Float): JJImageButton {
        mConstraintSet.setRotationY(id,float)
        return this
    }

    fun clTranslation(x: Float,y: Float): JJImageButton {
        mConstraintSet.setTranslation(id,x,y)
        return this
    }
    fun clTranslationX(x: Float): JJImageButton {
        mConstraintSet.setTranslationX(id,x)
        return this
    }

    fun clTranslationY(y: Float): JJImageButton {
        mConstraintSet.setTranslationY(id,y)
        return this
    }

    fun clTranslationZ(z: Float): JJImageButton {
        mConstraintSet.setTranslationZ(id,z)
        return this
    }

    fun clTransformPivot(x: Float, y: Float): JJImageButton {
        mConstraintSet.setTransformPivot(id,x,y)
        return this
    }

    fun clTransformPivotX(x: Float): JJImageButton {
        mConstraintSet.setTransformPivotX(id,x)
        return this
    }

    fun clTransformPivotY(y: Float): JJImageButton {
        mConstraintSet.setTransformPivotY(id,y)
        return this
    }

    fun clScaleX(x: Float): JJImageButton {
        mConstraintSet.setScaleX(id,x)
        return this
    }

    fun clScaleY(y: Float): JJImageButton {
        mConstraintSet.setScaleY(id,y)
        return this
    }

    fun clDimensionRatio(ratio: String): JJImageButton {
        mConstraintSet.setDimensionRatio(id,ratio)
        return this
    }

    fun clAlpha(alpha: Float): JJImageButton {
        mConstraintSet.setAlpha(id,alpha)
        return this
    }
    ...
    fun clMinWidth(w:Int): JJImageButton {
        mConstraintSet.constrainMinWidth(id,w)
        return this
    }

    fun clMinHeight(h:Int): JJImageButton {
        mConstraintSet.constrainMinHeight(id,h)
        return this
    }

    fun clMaxWidth(w:Int): JJImageButton {
        mConstraintSet.constrainMaxWidth(id,w)
        return this
    }

    fun clMaxHeight(h:Int): JJImageButton {
        mConstraintSet.constrainMaxHeight(id,h)
        return this
    }


    fun clVisibilityMode(mode: Int): JJImageButton {
        mConstraintSet.setVisibilityMode(id,mode)
        return this
    }


    fun clApply(): JJImageButton {
        mConstraintSet.applyTo(parent as ConstraintLayout)
        return this
    }

    fun clVerticalBias(float: Float): JJImageButton {
        mConstraintSet.setVerticalBias(id,float)
        return this
    }
    fun clHorizontalBias(float: Float): JJImageButton {
        mConstraintSet.setHorizontalBias(id,float)
        return this
    }

    fun clCenterHorizontallyOf(viewId: Int): JJImageButton {
    ...
    fun clCenterVerticallyOf(viewId: Int): JJImageButton {
    ...
    fun clMargins(margins: JJMargin) : JJImageButton {
    ...
    fun clCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJImageButton {
    ...
    fun clCenterInParentVertically(): JJImageButton {
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSet.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mConstraintSet.setVerticalBias(id, 0.5f)
        return this
    ...
    fun clCenterInParentHorizontally(): JJImageButton {
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSet.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mConstraintSet.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun clCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJImageButton {
    ...
    fun clCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJImageButton {
    ...
    fun clCenterInParentTopVertically(): JJImageButton {
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun clCenterInParentBottomVertically(): JJImageButton {
    ...
    fun clCenterInParentStartHorizontally(): JJImageButton {
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun clCenterInParentEndHorizontally(): JJImageButton {
    ...
    fun clCenterInTopVertically(topId: Int): JJImageButton {
    ...
    fun clCenterInBottomVertically(bottomId: Int): JJImageButton {
    ...
    fun clCenterInStartHorizontally(startId: Int): JJImageButton {
    ...
    fun clCenterInEndHorizontally(endId: Int): JJImageButton {
    ...
    fun clCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJImageButton {
        mConstraintSet.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun clCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJImageButton {
        mConstraintSet.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun clFillParent(): JJImageButton {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun clFillParent(margin: JJMargin): JJImageButton {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun clFillParentHorizontally(): JJImageButton {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSet.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun clFillParentVertically(): JJImageButton {
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSet.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun clFillParentHorizontally(startMargin: Int, endMargin: Int): JJImageButton {
        mConstraintSet.constrainWidth(id,0)
        mConstraintSet.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun clFillParentVertically(topMargin: Int, bottomMargin: Int): JJImageButton {
        mConstraintSet.constrainHeight(id,0)
        mConstraintSet.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mConstraintSet.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun clVisibility(visibility: Int): JJImageButton {
        mConstraintSet.setVisibility(id, visibility)
        return this
    }

    fun clElevation(elevation: Float): JJImageButton {
