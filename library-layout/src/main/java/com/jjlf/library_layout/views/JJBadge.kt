...
class JJBadge : View {
    ...
    constructor(context: Context, attrs: AttributeSet?):super(context,attrs){
        ...
        val aCenterInTopVerticalOf = a.getResourceId(R.styleable.JJBadge_clCenterInTopVerticallyOf,NO_ID)
        val aCenterInBottomVerticalOf = a.getResourceId(R.styleable.JJBadge_clCenterInBottomVerticallyOf,NO_ID)
        val aCenterInStartHorizontalOf= a.getResourceId(R.styleable.JJBadge_clCenterInStartHorizontallyOf,NO_ID)
        val aCenterInEndHorizontalOf = a.getResourceId(R.styleable.JJBadge_clCenterInEndHorizontallyOf,NO_ID)

        val aCenterVerticalOf = a.getResourceId(R.styleable.JJBadge_clCenterVerticallyOf,NO_ID)
        val aCenterHorizontalOf = a.getResourceId(R.styleable.JJBadge_clCenterHorizontallyOf,NO_ID)
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJBadge_clMargin,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJBadge_clMargin,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJBadge_clMargin,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJBadge_clMargin,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJBadge_clMargin,NO_ID)
        ...
        val aStartToStartOf = a.getResourceId(R.styleable.JJBadge_clStartToStartOf,NO_ID)
        val aStartToEndOf = a.getResourceId(R.styleable.JJBadge_clStartToEndOf,NO_ID)
        val aEndToEndOf = a.getResourceId(R.styleable.JJBadge_clEndToEndOf,NO_ID)
        val aEndToStartOf = a.getResourceId(R.styleable.JJBadge_clEndToStartOf,NO_ID)
        val aTopToTopOf = a.getResourceId(R.styleable.JJBadge_clTopToTopOf,NO_ID)
        val aTopToBottomOf = a.getResourceId(R.styleable.JJBadge_clTopToBottomOf,NO_ID)
        val aBottomToBottomOf = a.getResourceId(R.styleable.JJBadge_clBottomToBottomOf,NO_ID)
        val aBottomToTopOf = a.getResourceId(R.styleable.JJBadge_clBottomToTopOf,NO_ID)
        ...
        val aHeightResponsive = a.getResourceId(R.styleable.JJBadge_clHeightResponsive,NO_ID)
        val aWidthResponsive = a.getResourceId(R.styleable.JJBadge_clWidthResponsive,NO_ID)

        val aHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_clHeightResponsivePercentScreenHeight,NO_ID)
        val aWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_clWidthResponsivePercentScreenWidth,NO_ID)
        val aHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_clHeightResponsivePercentScreenWidth,NO_ID)
        val aWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_clWidthResponsivePercentScreenHeight,NO_ID)
        ...
        val lHeightResponsive = a.getResourceId(R.styleable.JJBadge_lpHeightResponsive,NO_ID)
        val lWidthResponsive = a.getResourceId(R.styleable.JJBadge_lpWidthResponsive,NO_ID)
        val lHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpHeightResponsivePercentScreenHeight,NO_ID)
        val lWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpWidthResponsivePercentScreenWidth,NO_ID)
        val lHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpHeightResponsivePercentScreenWidth,NO_ID)
        val lWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpWidthResponsivePercentScreenHeight,NO_ID)
        ...
        val lMarginTopResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginTopResponsive,NO_ID)
        val lMarginLeftResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginLeftResponsive,NO_ID)
        val lMarginRightResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginRightResponsive,NO_ID)
        val lMarginBottomResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginBottomResponsive,NO_ID)

        val lMarginTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginTopResPerScWidth,NO_ID)
        val lMarginLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginLeftResPerScWidth,NO_ID)
        val lMarginRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginRightResPerScWidth,NO_ID)
        val lMarginBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginBottomResPerScWidth,NO_ID)

        val lMarginTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginTopResPerScHeight,NO_ID)
        val lMarginLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginLeftResPerScHeight,NO_ID)
        val lMarginRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginRightResPerScHeight,NO_ID)
        val lMarginBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginBottomResPerScHeight,NO_ID)
        ...
        val lMarginResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginResponsive,NO_ID)
        val lMarginResPerScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginResPerScHeight,NO_ID)
        val lMarginResPerScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginResPerScWidth,NO_ID)
        ...
        val lMarginVerticalResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginVerticalResponsive,NO_ID)
        val lMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginVerticalResPerScWidth,NO_ID)
        val lMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginVerticalResPerScHeight,NO_ID)
        ...
        val lMarginHorizontalResponsive = a.getResourceId(R.styleable.JJBadge_lpMarginHorizontalResponsive,NO_ID)
        val lMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJBadge_lpMarginHorizontalResPerScWidth,NO_ID)
        val lMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJBadge_lpMarginHorizontalResPerScHeight,NO_ID)
        ...
        val lPaddingTopResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingTopResponsive,NO_ID)
        val lPaddingLeftResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingLeftResponsive,NO_ID)
        val lPaddingRightResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingRightResponsive,NO_ID)
        val lPaddingBottomResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingBottomResponsive,NO_ID)

        val lPaddingTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingTopResPerScWidth,NO_ID)
        val lPaddingLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingLeftResPerScWidth,NO_ID)
        val lPaddingRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingRightResPerScWidth,NO_ID)
        val lPaddingBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingBottomResPerScWidth,NO_ID)

        val lPaddingTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingTopResPerScHeight,NO_ID)
        val lPaddingLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingLeftResPerScHeight,NO_ID)
        val lPaddingRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingRightResPerScHeight,NO_ID)
        val lPaddingBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingBottomResPerScHeight,NO_ID)
        ...
        val lPaddingResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingResponsive,NO_ID)
        val lPaddingResPerScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingResPerScHeight,NO_ID)
        val lPaddingResPerScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingResPerScWidth,NO_ID)
        ...
        val lPaddingVerticalResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingVerticalResponsive,NO_ID)
        val lPaddingVerticalResPerScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingVerticalResPerScWidth,NO_ID)
        val lPaddingVerticalResPerScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingVerticalResPerScHeight,NO_ID)
        ...
        val lPaddingHorizontalResponsive = a.getResourceId(R.styleable.JJBadge_lpPaddingHorizontalResponsive,NO_ID)
        val lPaddingHorizontalResPerScWidth = a.getResourceId(R.styleable.JJBadge_lpPaddingHorizontalResPerScWidth,NO_ID)
        val lPaddingHorizontalResPerScHeight = a.getResourceId(R.styleable.JJBadge_lpPaddingHorizontalResPerScHeight,NO_ID)


        mText = a.getString(R.styleable.JJBadge_b_text) ?: ""
        mPaintText.color = a.getColor(R.styleable.JJBadge_b_textColor,Color.BLACK)
        mPaintText.textSize = a.getDimension(R.styleable.JJBadge_b_textSize,20f)
        if (a.hasValue(R.styleable.JJBadge_b_font)) {
            val fontFamilyId = R.styleable.JJBadge_b_font
            val fontFamilyName = a.getString(fontFamilyId)
            if (fontFamilyName != null) mPaintText.typeface = Typeface.create(fontFamilyName, Typeface.NORMAL)
        }
        if (a.hasValue(R.styleable.JJBadge_b_strokeColor)) {
            mBadgePaintStroke.color = a.getColor(R.styleable.JJBadge_b_strokeColor, Color.BLACK)
            mBadgeIsStrokeEnabled = true
        }
        
        

        mIsTextHidden = a.getBoolean(R.styleable.JJBadge_b_isTextHidden,false)
    ...
    private fun measureDimension(desiredSize: Int, measureSpec: Int,min:Int,max:Int): Int {
        ...
        if (result < desiredSize) {
            Log.e("JJBadgeCounter", "The view size is too small, the content might get cut")
        }
        return result
    }
    ...
    override fun draw(canvas: Canvas?) {
        ...
        mPath.reset()
        mPath.addRoundRect(mRectBadge,radius,radius,Path.Direction.CW)
    ...
    fun colWidth(width: Int): JJBadge {
        setupCol()
        mCol!!.width = width
        return this
    }

    fun colHeight(height: Int): JJBadge {
        setupCol()
        mCol!!.height = height
        return this
    }

    fun colGravity(gravity: Int): JJBadge {
        setupCol()
    ...
    fun ablWidth(width: Int): JJBadge {
        setupAblp()
        ablp!!.width = width
        return this
    }

    fun ablHeight(height: Int): JJBadge {
        setupAblp()
        ablp!!.height = height
        return this
    }

    fun ablScrollFlags(flags: Int) : JJBadge {
        setupAblp()
        ablp!!.scrollFlags = flags
        return this
    }

    fun ablScrollInterpolator(interpolator: Interpolator) : JJBadge {
        setupAblp()
        ablp!!.scrollInterpolator = interpolator
        return this
    }

    fun ablMargins(margins: JJMargin): JJBadge {
        setupAblp()
