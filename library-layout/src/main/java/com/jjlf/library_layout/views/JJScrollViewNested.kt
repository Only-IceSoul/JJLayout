...
//endregion
    ...
    fun colGravity(gravity: Int): JJScrollViewNested {
        setupCol()
    ...
    fun ablScrollFlags(flags: Int) : JJScrollViewNested {
        setupAblp()
        (layoutParams as? AppBarLayout.LayoutParams)?.scrollFlags = flags
        return this
    }

    fun ablScrollInterpolator(interpolator: Interpolator) : JJScrollViewNested {
        setupAblp()
    ...
    fun rlAlignParentTop(value : Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentStart(value : Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentEnd(value : Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentLeft(value : Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentRight(value : Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentVertically(value:Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentHorizontally(value:Boolean = true): JJScrollViewNested {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignBaseline(viewId: Int): JJScrollViewNested {
        setupRlp()
    ...
    fun llWeight(w: Float): JJScrollViewNested {
        setupLlp()
    ...
    fun cllVisibilityMode(visibility: Int): JJScrollViewNested {
        mConstraintSetLandScape.setVisibilityMode(id, visibility)
        return this
    }

    fun cllVerticalBias(float: Float): JJScrollViewNested {
        mConstraintSetLandScape.setVerticalBias(id,float)
        return this
    }
    fun cllHorizontalBias(float: Float): JJScrollViewNested {
        mConstraintSetLandScape.setHorizontalBias(id,float)
        return this
    }

    fun cllCenterHorizontallyOf(viewId: Int, marginStart: Int = 0, marginEnd: Int = 0): JJScrollViewNested {
    ...
    fun cllCenterVerticallyOf(viewId: Int,marginTop: Int = 0, marginBottom: Int = 0): JJScrollViewNested {
    ...
    fun cllMargins(margins: JJMargin) : JJScrollViewNested {
    ...
    fun cllCenterInParent(verticalBias: Float, horizontalBias: Float, margin: JJMargin): JJScrollViewNested {
    ...
    fun cllCenterInParentVertically(): JJScrollViewNested {
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        mConstraintSetLandScape.setVerticalBias(id, 0.5f)
        return this
    ...
    fun cllCenterInParentHorizontally(): JJScrollViewNested {
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        mConstraintSetLandScape.setHorizontalBias(id, 0.5f)
        return this
    ...
    fun cllCenterInParentVertically(bias: Float, topMargin: Int, bottomMargin: Int): JJScrollViewNested {
    ...
    fun cllCenterInParentHorizontally(bias: Float, startMargin: Int, endtMargin: Int): JJScrollViewNested {
    ...
    fun cllCenterInParentTopVertically(): JJScrollViewNested {
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
    ...
    fun cllCenterInParentBottomVertically(): JJScrollViewNested {
    ...
    fun cllCenterInParentStartHorizontally(): JJScrollViewNested {
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun cllCenterInParentEndHorizontally(): JJScrollViewNested {
    ...
    fun cllCenterInTopVertically(topId: Int): JJScrollViewNested {
    ...
    fun cllCenterInBottomVertically(bottomId: Int): JJScrollViewNested {
    ...
    fun cllCenterInStartHorizontally(startId: Int): JJScrollViewNested {
    ...
    fun cllCenterInEndHorizontally(endId: Int): JJScrollViewNested {
    ...
    fun cllCenterVertically(topId: Int, topSide: Int, topMargin: Int, bottomId: Int, bottomSide: Int, bottomMargin: Int, bias: Float): JJScrollViewNested {
        mConstraintSetLandScape.centerVertically(id, topId, topSide, topMargin, bottomId, bottomSide, bottomMargin, bias)
        return this
    }

    fun cllCenterHorizontally(startId: Int, startSide: Int, startMargin: Int, endId: Int, endSide: Int, endMargin: Int, bias: Float): JJScrollViewNested {
        mConstraintSetLandScape.centerHorizontally(id, startId, startSide, startMargin, endId, endSide, endMargin, bias)
        return this
    }


    fun cllFillParent(): JJScrollViewNested {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
    ...
    fun cllFillParent(margin: JJMargin): JJScrollViewNested {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, margin.top)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, margin.left)
    ...
    fun cllFillParentHorizontally(): JJScrollViewNested {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.END, ConstraintSet.PARENT_ID, ConstraintSet.END, 0)
        return this
    ...
    fun cllFillParentVertically(): JJScrollViewNested {
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, 0)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, 0)
        return this
    ...
    fun cllFillParentHorizontally(startMargin: Int, endMargin: Int): JJScrollViewNested {
        mConstraintSetLandScape.constrainWidth(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.START, ConstraintSet.PARENT_ID, ConstraintSet.START, startMargin)
    ...
    fun cllFillParentVertically(topMargin: Int, bottomMargin: Int): JJScrollViewNested {
        mConstraintSetLandScape.constrainHeight(id,0)
        mConstraintSetLandScape.connect(id, ConstraintSet.TOP, ConstraintSet.PARENT_ID, ConstraintSet.TOP, topMargin)
        mConstraintSetLandScape.connect(id, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM, bottomMargin)
        return this
    ...
    fun cllVisibility(visibility: Int): JJScrollViewNested {
    ...
    fun cllElevation(elevation: Float): JJScrollViewNested {
    ...
    fun cllMinWidth(w:Int): JJScrollViewNested {
        mConstraintSetLandScape.constrainMinWidth(id,w)
        return this
    }

    fun cllMinHeight(h:Int): JJScrollViewNested {
        mConstraintSetLandScape.constrainMinHeight(id,h)
        return this
    }

    fun cllMaxWidth(w:Int): JJScrollViewNested {
        mConstraintSetLandScape.constrainMaxWidth(id,w)
        return this
    }

    fun cllMaxHeight(h:Int): JJScrollViewNested {
