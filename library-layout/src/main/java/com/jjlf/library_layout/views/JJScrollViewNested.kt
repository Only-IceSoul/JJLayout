...
open class JJScrollViewNested : NestedScrollView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs){
        ...
        mConfigurationChanged = a.getBoolean(R.styleable.JJScrollViewNested_support_configuration_changed,false)
        mSupportLandScape = a.getBoolean(R.styleable.JJScrollViewNested_support_landscape,false)
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJScrollViewNested_clMarginPerScHeight,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_clMarginPerScWidth,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJScrollViewNested_clMarginResponsive,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_clMarginResPerScHeight,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_clMarginResPerScWidth,NO_ID)
        ...
        val alsFillParent = a.getBoolean(R.styleable.JJScrollViewNested_cllFillParent,false)
        val alsFillParentHorizontal = a.getBoolean(R.styleable.JJScrollViewNested_cllFillParentHorizontally,false)
        val alsFillParentVertical = a.getBoolean(R.styleable.JJScrollViewNested_cllFillParentVertically,false)

        val alsCenterInParent = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParent,false)
        val alsCenterInParentHorizontal = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParentHorizontally,false)
        val alsCenterInParentVertical = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParentVertically,false)
        val alsCenterInParentTopVertical = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParentTopVertically,false)
        val alsCenterInParentBottomVertical = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParentBottomVertically,false)
        val alsCenterInParentStartHorizontal = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParentStartHorizontally,false)
        val alsCenterInParentEndHorizontal = a.getBoolean(R.styleable.JJScrollViewNested_cllCenterInParentEndHorizontally,false)

        val alsCenterInTopVerticalOf = a.getResourceId(R.styleable.JJScrollViewNested_cllCenterInTopVerticallyOf,View.NO_ID)
        val alsCenterInBottomVerticalOf = a.getResourceId(R.styleable.JJScrollViewNested_cllCenterInBottomVerticallyOf,View.NO_ID)
        val alsCenterInStartHorizontalOf= a.getResourceId(R.styleable.JJScrollViewNested_cllCenterInStartHorizontallyOf,View.NO_ID)
        val alsCenterInEndHorizontalOf = a.getResourceId(R.styleable.JJScrollViewNested_cllCenterInEndHorizontallyOf,View.NO_ID)

        val alsCenterVerticalOf = a.getResourceId(R.styleable.JJScrollViewNested_cllCenterVerticallyOf,View.NO_ID)
        val alsCenterHorizontalOf = a.getResourceId(R.styleable.JJScrollViewNested_cllCenterHorizontallyOf,View.NO_ID)

        val alsMarginEnd = a.getDimension(R.styleable.JJScrollViewNested_cllMarginEnd,0f)
        val alsMarginStart = a.getDimension(R.styleable.JJScrollViewNested_cllMarginStart,0f)
        val alsMarginTop = a.getDimension(R.styleable.JJScrollViewNested_cllMarginTop,0f)
        val alsMarginBottom = a.getDimension(R.styleable.JJScrollViewNested_cllMarginBottom,0f)
        val alsMarginEndPercent = a.getFloat(R.styleable.JJScrollViewNested_cllMarginEndPercentScreenHeight,0f)
        val alsMarginStartPercent = a.getFloat(R.styleable.JJScrollViewNested_cllMarginStartPercentScreenHeight,0f)
        val alsMarginTopPercent = a.getFloat(R.styleable.JJScrollViewNested_cllMarginTopPercentScreenHeight,0f)
        val alsMarginBottomPercent = a.getFloat(R.styleable.JJScrollViewNested_cllMarginBottomPercentScreenHeight,0f)
        val alsMarginEndPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginEndPercentScreenWidth,0f)
        val alsMarginStartPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginStartPercentScreenWidth,0f)
        val alsMarginTopPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginTopPercentScreenWidth,0f)
        val alsMarginBottomPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginBottomPercentScreenWidth,0f)

        val alsMargin = a.getDimension(R.styleable.JJScrollViewNested_cllMargin,0f)
        val alsMarginPercentHeight = a.getFloat(R.styleable.JJScrollViewNested_cllMarginPerScHeight,0f)
        val alsMarginPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginPerScWidth,0f)
        val alsMarginResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginResponsive,NO_ID)
        val alsMarginResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginResPerScHeight,NO_ID)
        val alsMarginResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginResPerScWidth,NO_ID)

        val alsMarginEndResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginEndResponsive,NO_ID)
        val alsMarginStartResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginStartResponsive,NO_ID)
        val alsMarginTopResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginTopResponsive,NO_ID)
        val alsMarginBottomResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginBottomResponsive,NO_ID)
        val alsMarginEndResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginEndResPerScHeight,NO_ID)
        val alsMarginStartResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginStartResPerScHeight,NO_ID)
        val alsMarginTopResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginTopResPerScHeight,NO_ID)
        val alsMarginBottomResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginBottomResPerScHeight,NO_ID)
        val alsMarginEndResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginEndResPerScWidth,NO_ID)
        val alsMarginStartResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginStartResPerScWidth,NO_ID)
        val alsMarginTopResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginTopResPerScWidth,NO_ID)
        val alsMarginBottomResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginBottomResPerScWidth,NO_ID)

        val alsMarginVertical = a.getDimension(R.styleable.JJScrollViewNested_cllMarginVertical,0f)
        val alsMarginVerticalPercentHeight = a.getFloat(R.styleable.JJScrollViewNested_cllMarginVerticalPerScHeight,0f)
        val alsMarginVerticalPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginVerticalPerScWidth,0f)
        val alsMarginVerticalResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginVerticalResponsive,NO_ID)
        val alsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginVerticalResPerScHeight,NO_ID)
        val alsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginVerticalResPerScWidth,NO_ID)

        val alsMarginHorizontal = a.getDimension(R.styleable.JJScrollViewNested_cllMarginHorizontal,0f)
        val alsMarginHorizontalPercentHeight = a.getFloat(R.styleable.JJScrollViewNested_cllMarginHorizontalPerScHeight,0f)
        val alsMarginHorizontalPercentWidth = a.getFloat(R.styleable.JJScrollViewNested_cllMarginHorizontalPerScWidth,0f)
        val alsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginHorizontalResponsive,NO_ID)
        val alsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginHorizontalResPerScHeight,NO_ID)
        val alsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllMarginHorizontalResPerScWidth,NO_ID)


        val alsVerticalBias = a.getFloat(R.styleable.JJScrollViewNested_cllVerticalBias,0.5f)
        val alsHorizontalBias = a.getFloat(R.styleable.JJScrollViewNested_cllHorizontalBias,0.5f)

        val alsStartToStartParent = a.getBoolean(R.styleable.JJScrollViewNested_cllStartToStartParent,false)
        val alsStartToEndParent = a.getBoolean(R.styleable.JJScrollViewNested_cllStartToEndParent,false)
        val alsEndToEndParent = a.getBoolean(R.styleable.JJScrollViewNested_cllEndToEndParent,false)
        val alsEndToStartParent = a.getBoolean(R.styleable.JJScrollViewNested_cllEndToStartParent,false)
        val alsTopToTopParent = a.getBoolean(R.styleable.JJScrollViewNested_cllTopToTopParent,false)
        val alsTopToBottomParent = a.getBoolean(R.styleable.JJScrollViewNested_cllTopToBottomParent,false)
        val alsBottomToBottomParent = a.getBoolean(R.styleable.JJScrollViewNested_cllBottomToBottomParent,false)
        val alsBottomToTopParent = a.getBoolean(R.styleable.JJScrollViewNested_cllBottomToTopParent,false)

        val alsStartToStartOf = a.getResourceId(R.styleable.JJScrollViewNested_cllStartToStartOf,View.NO_ID)
        val alsStartToEndOf = a.getResourceId(R.styleable.JJScrollViewNested_cllStartToEndOf,View.NO_ID)
        val alsEndToEndOf = a.getResourceId(R.styleable.JJScrollViewNested_cllEndToEndOf,View.NO_ID)
        val alsEndToStartOf = a.getResourceId(R.styleable.JJScrollViewNested_cllEndToStartOf,View.NO_ID)
        val alsTopToTopOf = a.getResourceId(R.styleable.JJScrollViewNested_cllTopToTopOf,View.NO_ID)
        val alsTopToBottomOf = a.getResourceId(R.styleable.JJScrollViewNested_cllTopToBottomOf,View.NO_ID)
        val alsBottomToBottomOf = a.getResourceId(R.styleable.JJScrollViewNested_cllBottomToBottomOf,View.NO_ID)
        val alsBottomToTopOf = a.getResourceId(R.styleable.JJScrollViewNested_cllBottomToTopOf,View.NO_ID)

        val alsHeightPercent = a.getFloat(R.styleable.JJScrollViewNested_cllHeightPercent,0f)
        val alsWidthPercent = a.getFloat(R.styleable.JJScrollViewNested_cllWidthPercent,0f)
        val alsHeightPercentScreenWidth = a.getFloat(R.styleable.JJScrollViewNested_cllHeightPercentScreenWidth,0f)
        val alsWidthPercentScreenWidth = a.getFloat(R.styleable.JJScrollViewNested_cllWidthPercentScreenWidth,0f)
        val alsHeightPercentScreenHeight = a.getFloat(R.styleable.JJScrollViewNested_cllHeightPercentScreenHeight,0f)
        val alsWidthPercentScreenHeight = a.getFloat(R.styleable.JJScrollViewNested_cllWidthPercentScreenHeight,0f)

        val alsHeightResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllHeightResponsive,View.NO_ID)
        val alsWidthResponsive = a.getResourceId(R.styleable.JJScrollViewNested_cllWidthResponsive,View.NO_ID)

        val alsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllHeightResponsivePercentScreenHeight,View.NO_ID)
        val alsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllWidthResponsivePercentScreenWidth,View.NO_ID)
        val alsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_cllHeightResponsivePercentScreenWidth,View.NO_ID)
        val alsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_cllWidthResponsivePercentScreenHeight,View.NO_ID)


        val attrHeightLs = a.getLayoutDimension(R.styleable.JJScrollViewNested_layout_height_landscape,0)
        val attrWidthLs = a.getLayoutDimension(R.styleable.JJScrollViewNested_layout_width_landscape,0)

        val llsPadding = a.getDimension(R.styleable.JJScrollViewNested_lplPadding,-100f)
        val llsPaddingVertical = a.getDimension(R.styleable.JJScrollViewNested_lplPaddingVertical,-100f)
        val llsPaddingHorizontal = a.getDimension(R.styleable.JJScrollViewNested_lplPaddingHorizontal,-100f)
        val llsPaddingStart = a.getDimension(R.styleable.JJScrollViewNested_lplPaddingStart,-100f)
        val llsPaddingEnd = a.getDimension(R.styleable.JJScrollViewNested_lplPaddingEnd,-100f)
        val llsPaddingBottom = a.getDimension(R.styleable.JJScrollViewNested_lplPaddingBottom,-100f)
        val llsPaddingTop = a.getDimension(R.styleable.JJScrollViewNested_lplPaddingTop,-100f)

        val llsMargin = a.getDimension(R.styleable.JJScrollViewNested_lplMargin,-100f)
        val llsMarginVertical = a.getDimension(R.styleable.JJScrollViewNested_lplMarginVertical,-100f)
        val llsMarginHorizontal = a.getDimension(R.styleable.JJScrollViewNested_lplMarginHorizontal,-100f)
        val llsMarginStart = a.getDimension(R.styleable.JJScrollViewNested_lplMarginStart,-100f)
        val llsMarginEnd = a.getDimension(R.styleable.JJScrollViewNested_lplMarginEnd,-100f)
        val llsMarginBottom = a.getDimension(R.styleable.JJScrollViewNested_lplMarginBottom,-100f)
        val llsMarginTop = a.getDimension(R.styleable.JJScrollViewNested_lplMarginTop,-100f)

        val llsHeightPercentScreenWidth = a.getFloat(R.styleable.JJScrollViewNested_lplHeightPercentScreenWidth,0f)
        val llsWidthPercentScreenWidth = a.getFloat(R.styleable.JJScrollViewNested_lplWidthPercentScreenWidth,0f)
        val llsHeightPercentScreenHeight = a.getFloat(R.styleable.JJScrollViewNested_lplHeightPercentScreenHeight,0f)
        val llsWidthPercentScreenHeight = a.getFloat(R.styleable.JJScrollViewNested_lplWidthPercentScreenHeight,0f)

        val llsHeightResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplHeightResponsive,View.NO_ID)
        val llsWidthResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplWidthResponsive,View.NO_ID)
        val llsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplHeightResponsivePercentScreenHeight,View.NO_ID)
        val llsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplWidthResponsivePercentScreenWidth,View.NO_ID)
        val llsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplHeightResponsivePercentScreenWidth,View.NO_ID)
        val llsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplWidthResponsivePercentScreenHeight,View.NO_ID)

        val llsMarginTopPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginTopPerScHeight,0f)
        val llsMarginLeftPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginLeftPerScHeight,0f)
        val llsMarginRightPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginRightPerScHeight,0f)
        val llsMarginBottomPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginBottomPerScHeight,0f)

        val llsMarginTopPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginTopPerScWidth,0f)
        val llsMarginLeftPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginLeftPerScWidth,0f)
        val llsMarginRightPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginRightPerScWidth,0f)
        val llsMarginBottomPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginBottomPerScWidth,0f)

        val llsMarginTopResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginTopResponsive,View.NO_ID)
        val llsMarginLeftResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginLeftResponsive,View.NO_ID)
        val llsMarginRightResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginRightResponsive,View.NO_ID)
        val llsMarginBottomResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginBottomResponsive,View.NO_ID)

        val llsMarginTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginTopResPerScWidth,View.NO_ID)
        val llsMarginLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginLeftResPerScWidth,View.NO_ID)
        val llsMarginRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginRightResPerScWidth,View.NO_ID)
        val llsMarginBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginBottomResPerScWidth,View.NO_ID)

        val llsMarginTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginTopResPerScHeight,View.NO_ID)
        val llsMarginLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginLeftResPerScHeight,View.NO_ID)
        val llsMarginRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginRightResPerScHeight,View.NO_ID)
        val llsMarginBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginBottomResPerScHeight,View.NO_ID)

        val llsMarginPerScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginPercentScHeight,0f)
        val llsMarginPerScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginPercentScWidth,0f)
        val llsMarginResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginResponsive,View.NO_ID)
        val llsMarginResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginResPerScHeight,View.NO_ID)
        val llsMarginResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginResPerScWidth,View.NO_ID)

        val llsMarginVerticalPerScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginVerticalPerScHeight,0f)
        val llsMarginVerticalPerScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginVerticalPerScWidth,0f)
        val llsMarginVerticalResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginVerticalResponsive,View.NO_ID)
        val llsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginVerticalResPerScWidth,View.NO_ID)
        val llsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginVerticalResPerScHeight,View.NO_ID)

        val llsMarginHorizontalPerScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplMarginHorizontalPerScHeight,0f)
        val llsMarginHorizontalPerScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplMarginHorizontalPerScWidth,0f)
        val llsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginHorizontalResponsive,View.NO_ID)
        val llsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginHorizontalResPerScWidth,View.NO_ID)
        val llsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplMarginHorizontalResPerScHeight,View.NO_ID)


        val llsPaddingTopPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingTopPerScHeight,0f)
        val llsPaddingLeftPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingLeftPerScHeight,0f)
        val llsPaddingRightPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingRightPerScHeight,0f)
        val llsPaddingBottomPercentScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingBottomPerScHeight,0f)

        val llsPaddingTopPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingTopPerScWidth,0f)
        val llsPaddingLeftPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingLeftPerScWidth,0f)
        val llsPaddingRightPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingRightPerScWidth,0f)
        val llsPaddingBottomPercentScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingBottomPerScWidth,0f)

        val llsPaddingTopResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingTopResponsive,View.NO_ID)
        val llsPaddingLeftResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingLeftResponsive,View.NO_ID)
        val llsPaddingRightResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingRightResponsive,View.NO_ID)
        val llsPaddingBottomResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingBottomResponsive,View.NO_ID)

        val llsPaddingTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingTopResPerScWidth,View.NO_ID)
        val llsPaddingLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingLeftResPerScWidth,View.NO_ID)
        val llsPaddingRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingRightResPerScWidth,View.NO_ID)
        val llsPaddingBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingBottomResPerScWidth,View.NO_ID)

        val llsPaddingTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingTopResPerScHeight,View.NO_ID)
        val llsPaddingLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingLeftResPerScHeight,View.NO_ID)
        val llsPaddingRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingRightResPerScHeight,View.NO_ID)
        val llsPaddingBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingBottomResPerScHeight,View.NO_ID)

        val llsPaddingPerScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingPercentScHeight,0f)
        val llsPaddingPerScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingPercentScWidth,0f)
        val llsPaddingResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingResponsive,View.NO_ID)
        val llsPaddingResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingResPerScHeight,View.NO_ID)
        val llsPaddingResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingResPerScWidth,View.NO_ID)

        val llsPaddingVerticalPerScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingVerticalPerScHeight,0f)
        val llsPaddingVerticalPerScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingVerticalPerScWidth,0f)
        val llsPaddingVerticalResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingVerticalResponsive,View.NO_ID)
        val llsPaddingVerticalResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingVerticalResPerScWidth,View.NO_ID)
        val llsPaddingVerticalResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingVerticalResPerScHeight,View.NO_ID)

        val llsPaddingHorizontalPerScHeight = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingHorizontalPerScHeight,0f)
        val llsPaddingHorizontalPerScWidth = a.getFloat(R.styleable.JJScrollViewNested_lplPaddingHorizontalPerScWidth,0f)
        val llsPaddingHorizontalResponsive = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingHorizontalResponsive,View.NO_ID)
        val llsPaddingHorizontalResPerScWidth = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingHorizontalResPerScWidth,View.NO_ID)
        val llsPaddingHorizontalResPerScHeight = a.getResourceId(R.styleable.JJScrollViewNested_lplPaddingHorizontalResPerScHeight,View.NO_ID)
