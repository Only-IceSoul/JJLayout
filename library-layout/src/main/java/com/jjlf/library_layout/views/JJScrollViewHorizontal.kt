...
class JJScrollViewHorizontal : HorizontalScrollView {
    ...
    constructor(context: Context, attrs: AttributeSet?):super(context,attrs){
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJScrollViewHorizontal_clMargin,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJScrollViewHorizontal_clMargin,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJScrollViewHorizontal_clMargin,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJScrollViewHorizontal_clMargin,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJScrollViewHorizontal_clMargin,NO_ID)
