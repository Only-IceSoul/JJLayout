...
class JJRecyclerView : RecyclerView{
    ...
    constructor(context: Context, attrs: AttributeSet?):super(context,attrs){
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJRecyclerView_clMargin,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMargin,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMargin,View.NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMargin,View.NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMargin,View.NO_ID)
