...
open class JJRecyclerView : RecyclerView{
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs){
        ...
        val a = context.obtainStyledAttributes(attrs,
            R.styleable.JJRecyclerView, 0, 0)


        mIgnoreCl = a.getBoolean(R.styleable.JJRecyclerView_layout_ignoreCl,false)

        mConfigurationChanged = a.getBoolean(R.styleable.JJRecyclerView_support_configuration_changed,false)
        mSupportLandScape = a.getBoolean(R.styleable.JJRecyclerView_support_landscape,false)

        //region attrs portrait

        val aFillParent = a.getBoolean(R.styleable.JJRecyclerView_clFillParent,false)
        val aFillParentHorizontal = a.getBoolean(R.styleable.JJRecyclerView_clFillParentHorizontally,false)
        val aFillParentVertical = a.getBoolean(R.styleable.JJRecyclerView_clFillParentVertically,false)

        val aCenterInParent = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParent,false)
        val aCenterInParentHorizontal = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParentHorizontally,false)
        val aCenterInParentVertical = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParentVertically,false)
        val aCenterInParentTopVertical = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParentTopVertically,false)
        val aCenterInParentBottomVertical = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParentBottomVertically,false)
        val aCenterInParentStartHorizontal = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParentStartHorizontally,false)
        val aCenterInParentEndHorizontal = a.getBoolean(R.styleable.JJRecyclerView_clCenterInParentEndHorizontally,false)

        val aCenterInTopVerticalOf = a.getResourceId(R.styleable.JJRecyclerView_clCenterInTopVerticallyOf,View.NO_ID)
        val aCenterInBottomVerticalOf = a.getResourceId(R.styleable.JJRecyclerView_clCenterInBottomVerticallyOf,View.NO_ID)
        val aCenterInStartHorizontalOf= a.getResourceId(R.styleable.JJRecyclerView_clCenterInStartHorizontallyOf,View.NO_ID)
        val aCenterInEndHorizontalOf = a.getResourceId(R.styleable.JJRecyclerView_clCenterInEndHorizontallyOf,View.NO_ID)

        val aCenterVerticalOf = a.getResourceId(R.styleable.JJRecyclerView_clCenterVerticallyOf,View.NO_ID)
        val aCenterHorizontalOf = a.getResourceId(R.styleable.JJRecyclerView_clCenterHorizontallyOf,View.NO_ID)

        val aMarginEnd = a.getDimension(R.styleable.JJRecyclerView_clMarginEnd,0f)
        val aMarginStart = a.getDimension(R.styleable.JJRecyclerView_clMarginStart,0f)
        val aMarginTop = a.getDimension(R.styleable.JJRecyclerView_clMarginTop,0f)
        val aMarginBottom = a.getDimension(R.styleable.JJRecyclerView_clMarginBottom,0f)
        val aMarginEndPercent = a.getFloat(R.styleable.JJRecyclerView_clMarginEndPercentScreenHeight,0f)
        val aMarginStartPercent = a.getFloat(R.styleable.JJRecyclerView_clMarginStartPercentScreenHeight,0f)
        val aMarginTopPercent = a.getFloat(R.styleable.JJRecyclerView_clMarginTopPercentScreenHeight,0f)
        val aMarginBottomPercent = a.getFloat(R.styleable.JJRecyclerView_clMarginBottomPercentScreenHeight,0f)
        val aMarginEndPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginEndPercentScreenWidth,0f)
        val aMarginStartPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginStartPercentScreenWidth,0f)
        val aMarginTopPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginTopPercentScreenWidth,0f)
        val aMarginBottomPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginBottomPercentScreenWidth,0f)

        val aMargin = a.getDimension(R.styleable.JJRecyclerView_clMargin,0f)
        val aMarginPercentHeight = a.getFloat(R.styleable.JJRecyclerView_clMarginPerScHeight,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginPerScWidth,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginResponsive,View.NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginResPerScHeight,View.NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginResPerScWidth,View.NO_ID)

        val aMarginEndResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginEndResponsive,View.NO_ID)
        val aMarginStartResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginStartResponsive,View.NO_ID)
        val aMarginTopResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginTopResponsive,View.NO_ID)
        val aMarginBottomResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginBottomResponsive,View.NO_ID)
        val aMarginEndResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginEndResPerScHeight,View.NO_ID)
        val aMarginStartResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginStartResPerScHeight,View.NO_ID)
        val aMarginTopResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginTopResPerScHeight,View.NO_ID)
        val aMarginBottomResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginBottomResPerScHeight,View.NO_ID)
        val aMarginEndResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginEndResPerScWidth,View.NO_ID)
        val aMarginStartResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginStartResPerScWidth,View.NO_ID)
        val aMarginTopResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginTopResPerScWidth,View.NO_ID)
        val aMarginBottomResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginBottomResPerScWidth,View.NO_ID)

        val aMarginVertical = a.getDimension(R.styleable.JJRecyclerView_clMarginVertical,0f)
        val aMarginVerticalPercentHeight = a.getFloat(R.styleable.JJRecyclerView_clMarginVerticalPerScHeight,0f)
        val aMarginVerticalPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginVerticalPerScWidth,0f)
        val aMarginVerticalResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginVerticalResponsive,View.NO_ID)
        val aMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginVerticalResPerScHeight,View.NO_ID)
        val aMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginVerticalResPerScWidth,View.NO_ID)

        val aMarginHorizontal = a.getDimension(R.styleable.JJRecyclerView_clMarginHorizontal,0f)
        val aMarginHorizontalPercentHeight = a.getFloat(R.styleable.JJRecyclerView_clMarginHorizontalPerScHeight,0f)
        val aMarginHorizontalPercentWidth = a.getFloat(R.styleable.JJRecyclerView_clMarginHorizontalPerScWidth,0f)
        val aMarginHorizontalResponsive = a.getResourceId(R.styleable.JJRecyclerView_clMarginHorizontalResponsive,View.NO_ID)
        val aMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_clMarginHorizontalResPerScHeight,View.NO_ID)
        val aMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_clMarginHorizontalResPerScWidth,View.NO_ID)


        val aVerticalBias = a.getFloat(R.styleable.JJRecyclerView_clVerticalBias,0.5f)
        val aHorizontalBias = a.getFloat(R.styleable.JJRecyclerView_clHorizontalBias,0.5f)

        val aStartToStartParent = a.getBoolean(R.styleable.JJRecyclerView_clStartToStartParent,false)
        val aStartToEndParent = a.getBoolean(R.styleable.JJRecyclerView_clStartToEndParent,false)
        val aEndToEndParent = a.getBoolean(R.styleable.JJRecyclerView_clEndToEndParent,false)
        val aEndToStartParent = a.getBoolean(R.styleable.JJRecyclerView_clEndToStartParent,false)
        val aTopToTopParent = a.getBoolean(R.styleable.JJRecyclerView_clTopToTopParent,false)
        val aTopToBottomParent = a.getBoolean(R.styleable.JJRecyclerView_clTopToBottomParent,false)
        val aBottomToBottomParent = a.getBoolean(R.styleable.JJRecyclerView_clBottomToBottomParent,false)
        val aBottomToTopParent = a.getBoolean(R.styleable.JJRecyclerView_clBottomToTopParent,false)

        val aStartToStartOf = a.getResourceId(R.styleable.JJRecyclerView_clStartToStartOf,View.NO_ID)
        val aStartToEndOf = a.getResourceId(R.styleable.JJRecyclerView_clStartToEndOf,View.NO_ID)
        val aEndToEndOf = a.getResourceId(R.styleable.JJRecyclerView_clEndToEndOf,View.NO_ID)
        val aEndToStartOf = a.getResourceId(R.styleable.JJRecyclerView_clEndToStartOf,View.NO_ID)
        val aTopToTopOf = a.getResourceId(R.styleable.JJRecyclerView_clTopToTopOf,View.NO_ID)
        val aTopToBottomOf = a.getResourceId(R.styleable.JJRecyclerView_clTopToBottomOf,View.NO_ID)
        val aBottomToBottomOf = a.getResourceId(R.styleable.JJRecyclerView_clBottomToBottomOf,View.NO_ID)
        val aBottomToTopOf = a.getResourceId(R.styleable.JJRecyclerView_clBottomToTopOf,View.NO_ID)

        val aHeightPercent = a.getFloat(R.styleable.JJRecyclerView_clHeightPercent,0f)
        val aWidthPercent = a.getFloat(R.styleable.JJRecyclerView_clWidthPercent,0f)
        val aHeightPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_clHeightPercentScreenWidth,0f)
        val aWidthPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_clWidthPercentScreenWidth,0f)
        val aHeightPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_clHeightPercentScreenHeight,0f)
        val aWidthPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_clWidthPercentScreenHeight,0f)

        val aHeightResponsive = a.getResourceId(R.styleable.JJRecyclerView_clHeightResponsive,View.NO_ID)
        val aWidthResponsive = a.getResourceId(R.styleable.JJRecyclerView_clWidthResponsive,View.NO_ID)

        val aHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_clHeightResponsivePercentScreenHeight,View.NO_ID)
        val aWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_clWidthResponsivePercentScreenWidth,View.NO_ID)
        val aHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_clHeightResponsivePercentScreenWidth,View.NO_ID)
        val aWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_clWidthResponsivePercentScreenHeight,View.NO_ID)

        val lHeightPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_lpHeightPercentScreenWidth,0f)
        val lWidthPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_lpWidthPercentScreenWidth,0f)
        val lHeightPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_lpHeightPercentScreenHeight,0f)
        val lWidthPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_lpWidthPercentScreenHeight,0f)

        val lHeightResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpHeightResponsive,View.NO_ID)
        val lWidthResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpWidthResponsive,View.NO_ID)
        val lHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpHeightResponsivePercentScreenHeight,View.NO_ID)
        val lWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpWidthResponsivePercentScreenWidth,View.NO_ID)
        val lHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpHeightResponsivePercentScreenWidth,View.NO_ID)
        val lWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpWidthResponsivePercentScreenHeight,View.NO_ID)

        val lMarginTopPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginTopPerScHeight,0f)
        val lMarginLeftPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginLeftPerScHeight,0f)
        val lMarginRightPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginRightPerScHeight,0f)
        val lMarginBottomPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginBottomPerScHeight,0f)

        val lMarginTopPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginTopPerScWidth,0f)
        val lMarginLeftPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginLeftPerScWidth,0f)
        val lMarginRightPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginRightPerScWidth,0f)
        val lMarginBottomPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginBottomPerScWidth,0f)

        val lMarginTopResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginTopResponsive,View.NO_ID)
        val lMarginLeftResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginLeftResponsive,View.NO_ID)
        val lMarginRightResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginRightResponsive,View.NO_ID)
        val lMarginBottomResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginBottomResponsive,View.NO_ID)

        val lMarginTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginTopResPerScWidth,View.NO_ID)
        val lMarginLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginLeftResPerScWidth,View.NO_ID)
        val lMarginRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginRightResPerScWidth,View.NO_ID)
        val lMarginBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginBottomResPerScWidth,View.NO_ID)

        val lMarginTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginTopResPerScHeight,View.NO_ID)
        val lMarginLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginLeftResPerScHeight,View.NO_ID)
        val lMarginRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginRightResPerScHeight,View.NO_ID)
        val lMarginBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginBottomResPerScHeight,View.NO_ID)

        val lMarginPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginPercentScHeight,0f)
        val lMarginPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginPercentScWidth,0f)
        val lMarginResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginResponsive,View.NO_ID)
        val lMarginResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginResPerScHeight,View.NO_ID)
        val lMarginResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginResPerScWidth,View.NO_ID)

        val lMarginVerticalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginVerticalPerScHeight,0f)
        val lMarginVerticalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginVerticalPerScWidth,0f)
        val lMarginVerticalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginVerticalResponsive,View.NO_ID)
        val lMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginVerticalResPerScWidth,View.NO_ID)
        val lMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginVerticalResPerScHeight,View.NO_ID)

        val lMarginHorizontalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lpMarginHorizontalPerScHeight,0f)
        val lMarginHorizontalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lpMarginHorizontalPerScWidth,0f)
        val lMarginHorizontalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpMarginHorizontalResponsive,View.NO_ID)
        val lMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpMarginHorizontalResPerScWidth,View.NO_ID)
        val lMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpMarginHorizontalResPerScHeight,View.NO_ID)


        val lPaddingTopPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingTopPerScHeight,0f)
        val lPaddingLeftPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingLeftPerScHeight,0f)
        val lPaddingRightPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingRightPerScHeight,0f)
        val lPaddingBottomPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingBottomPerScHeight,0f)

        val lPaddingTopPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingTopPerScWidth,0f)
        val lPaddingLeftPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingLeftPerScWidth,0f)
        val lPaddingRightPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingRightPerScWidth,0f)
        val lPaddingBottomPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingBottomPerScWidth,0f)

        val lPaddingTopResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingTopResponsive,View.NO_ID)
        val lPaddingLeftResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingLeftResponsive,View.NO_ID)
        val lPaddingRightResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingRightResponsive,View.NO_ID)
        val lPaddingBottomResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingBottomResponsive,View.NO_ID)

        val lPaddingTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingTopResPerScWidth,View.NO_ID)
        val lPaddingLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingLeftResPerScWidth,View.NO_ID)
        val lPaddingRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingRightResPerScWidth,View.NO_ID)
        val lPaddingBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingBottomResPerScWidth,View.NO_ID)

        val lPaddingTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingTopResPerScHeight,View.NO_ID)
        val lPaddingLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingLeftResPerScHeight,View.NO_ID)
        val lPaddingRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingRightResPerScHeight,View.NO_ID)
        val lPaddingBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingBottomResPerScHeight,View.NO_ID)

        val lPaddingPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingPercentScHeight,0f)
        val lPaddingPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingPercentScWidth,0f)
        val lPaddingResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingResponsive,View.NO_ID)
        val lPaddingResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingResPerScHeight,View.NO_ID)
        val lPaddingResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingResPerScWidth,View.NO_ID)

        val lPaddingVerticalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingVerticalPerScHeight,0f)
        val lPaddingVerticalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingVerticalPerScWidth,0f)
        val lPaddingVerticalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingVerticalResponsive,View.NO_ID)
        val lPaddingVerticalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingVerticalResPerScWidth,View.NO_ID)
        val lPaddingVerticalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingVerticalResPerScHeight,View.NO_ID)

        val lPaddingHorizontalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lpPaddingHorizontalPerScHeight,0f)
        val lPaddingHorizontalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lpPaddingHorizontalPerScWidth,0f)
        val lPaddingHorizontalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingHorizontalResponsive,View.NO_ID)
        val lPaddingHorizontalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingHorizontalResPerScWidth,View.NO_ID)
        val lPaddingHorizontalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lpPaddingHorizontalResPerScHeight,View.NO_ID)
        ...
        val alsFillParent = a.getBoolean(R.styleable.JJRecyclerView_cllFillParent,false)
        val alsFillParentHorizontal = a.getBoolean(R.styleable.JJRecyclerView_cllFillParentHorizontally,false)
        val alsFillParentVertical = a.getBoolean(R.styleable.JJRecyclerView_cllFillParentVertically,false)

        val alsCenterInParent = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParent,false)
        val alsCenterInParentHorizontal = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParentHorizontally,false)
        val alsCenterInParentVertical = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParentVertically,false)
        val alsCenterInParentTopVertical = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParentTopVertically,false)
        val alsCenterInParentBottomVertical = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParentBottomVertically,false)
        val alsCenterInParentStartHorizontal = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParentStartHorizontally,false)
        val alsCenterInParentEndHorizontal = a.getBoolean(R.styleable.JJRecyclerView_cllCenterInParentEndHorizontally,false)

        val alsCenterInTopVerticalOf = a.getResourceId(R.styleable.JJRecyclerView_cllCenterInTopVerticallyOf,View.NO_ID)
        val alsCenterInBottomVerticalOf = a.getResourceId(R.styleable.JJRecyclerView_cllCenterInBottomVerticallyOf,View.NO_ID)
        val alsCenterInStartHorizontalOf= a.getResourceId(R.styleable.JJRecyclerView_cllCenterInStartHorizontallyOf,View.NO_ID)
        val alsCenterInEndHorizontalOf = a.getResourceId(R.styleable.JJRecyclerView_cllCenterInEndHorizontallyOf,View.NO_ID)

        val alsCenterVerticalOf = a.getResourceId(R.styleable.JJRecyclerView_cllCenterVerticallyOf,View.NO_ID)
        val alsCenterHorizontalOf = a.getResourceId(R.styleable.JJRecyclerView_cllCenterHorizontallyOf,View.NO_ID)

        val alsMarginEnd = a.getDimension(R.styleable.JJRecyclerView_cllMarginEnd,0f)
        val alsMarginStart = a.getDimension(R.styleable.JJRecyclerView_cllMarginStart,0f)
        val alsMarginTop = a.getDimension(R.styleable.JJRecyclerView_cllMarginTop,0f)
        val alsMarginBottom = a.getDimension(R.styleable.JJRecyclerView_cllMarginBottom,0f)
        val alsMarginEndPercent = a.getFloat(R.styleable.JJRecyclerView_cllMarginEndPercentScreenHeight,0f)
        val alsMarginStartPercent = a.getFloat(R.styleable.JJRecyclerView_cllMarginStartPercentScreenHeight,0f)
        val alsMarginTopPercent = a.getFloat(R.styleable.JJRecyclerView_cllMarginTopPercentScreenHeight,0f)
        val alsMarginBottomPercent = a.getFloat(R.styleable.JJRecyclerView_cllMarginBottomPercentScreenHeight,0f)
        val alsMarginEndPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginEndPercentScreenWidth,0f)
        val alsMarginStartPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginStartPercentScreenWidth,0f)
        val alsMarginTopPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginTopPercentScreenWidth,0f)
        val alsMarginBottomPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginBottomPercentScreenWidth,0f)

        val alsMargin = a.getDimension(R.styleable.JJRecyclerView_cllMargin,0f)
        val alsMarginPercentHeight = a.getFloat(R.styleable.JJRecyclerView_cllMarginPerScHeight,0f)
        val alsMarginPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginPerScWidth,0f)
        val alsMarginResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginResponsive,View.NO_ID)
        val alsMarginResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginResPerScHeight,View.NO_ID)
        val alsMarginResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginResPerScWidth,View.NO_ID)

        val alsMarginEndResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginEndResponsive,View.NO_ID)
        val alsMarginStartResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginStartResponsive,View.NO_ID)
        val alsMarginTopResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginTopResponsive,View.NO_ID)
        val alsMarginBottomResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginBottomResponsive,View.NO_ID)
        val alsMarginEndResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginEndResPerScHeight,View.NO_ID)
        val alsMarginStartResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginStartResPerScHeight,View.NO_ID)
        val alsMarginTopResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginTopResPerScHeight,View.NO_ID)
        val alsMarginBottomResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginBottomResPerScHeight,View.NO_ID)
        val alsMarginEndResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginEndResPerScWidth,View.NO_ID)
        val alsMarginStartResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginStartResPerScWidth,View.NO_ID)
        val alsMarginTopResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginTopResPerScWidth,View.NO_ID)
        val alsMarginBottomResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginBottomResPerScWidth,View.NO_ID)

        val alsMarginVertical = a.getDimension(R.styleable.JJRecyclerView_cllMarginVertical,0f)
        val alsMarginVerticalPercentHeight = a.getFloat(R.styleable.JJRecyclerView_cllMarginVerticalPerScHeight,0f)
        val alsMarginVerticalPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginVerticalPerScWidth,0f)
        val alsMarginVerticalResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginVerticalResponsive,View.NO_ID)
        val alsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginVerticalResPerScHeight,View.NO_ID)
        val alsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginVerticalResPerScWidth,View.NO_ID)

        val alsMarginHorizontal = a.getDimension(R.styleable.JJRecyclerView_cllMarginHorizontal,0f)
        val alsMarginHorizontalPercentHeight = a.getFloat(R.styleable.JJRecyclerView_cllMarginHorizontalPerScHeight,0f)
        val alsMarginHorizontalPercentWidth = a.getFloat(R.styleable.JJRecyclerView_cllMarginHorizontalPerScWidth,0f)
        val alsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllMarginHorizontalResponsive,View.NO_ID)
        val alsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllMarginHorizontalResPerScHeight,View.NO_ID)
        val alsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllMarginHorizontalResPerScWidth,View.NO_ID)


        val alsVerticalBias = a.getFloat(R.styleable.JJRecyclerView_cllVerticalBias,0.5f)
        val alsHorizontalBias = a.getFloat(R.styleable.JJRecyclerView_cllHorizontalBias,0.5f)

        val alsStartToStartParent = a.getBoolean(R.styleable.JJRecyclerView_cllStartToStartParent,false)
        val alsStartToEndParent = a.getBoolean(R.styleable.JJRecyclerView_cllStartToEndParent,false)
        val alsEndToEndParent = a.getBoolean(R.styleable.JJRecyclerView_cllEndToEndParent,false)
        val alsEndToStartParent = a.getBoolean(R.styleable.JJRecyclerView_cllEndToStartParent,false)
        val alsTopToTopParent = a.getBoolean(R.styleable.JJRecyclerView_cllTopToTopParent,false)
        val alsTopToBottomParent = a.getBoolean(R.styleable.JJRecyclerView_cllTopToBottomParent,false)
        val alsBottomToBottomParent = a.getBoolean(R.styleable.JJRecyclerView_cllBottomToBottomParent,false)
        val alsBottomToTopParent = a.getBoolean(R.styleable.JJRecyclerView_cllBottomToTopParent,false)

        val alsStartToStartOf = a.getResourceId(R.styleable.JJRecyclerView_cllStartToStartOf,View.NO_ID)
        val alsStartToEndOf = a.getResourceId(R.styleable.JJRecyclerView_cllStartToEndOf,View.NO_ID)
        val alsEndToEndOf = a.getResourceId(R.styleable.JJRecyclerView_cllEndToEndOf,View.NO_ID)
        val alsEndToStartOf = a.getResourceId(R.styleable.JJRecyclerView_cllEndToStartOf,View.NO_ID)
        val alsTopToTopOf = a.getResourceId(R.styleable.JJRecyclerView_cllTopToTopOf,View.NO_ID)
        val alsTopToBottomOf = a.getResourceId(R.styleable.JJRecyclerView_cllTopToBottomOf,View.NO_ID)
        val alsBottomToBottomOf = a.getResourceId(R.styleable.JJRecyclerView_cllBottomToBottomOf,View.NO_ID)
        val alsBottomToTopOf = a.getResourceId(R.styleable.JJRecyclerView_cllBottomToTopOf,View.NO_ID)

        val alsHeightPercent = a.getFloat(R.styleable.JJRecyclerView_cllHeightPercent,0f)
        val alsWidthPercent = a.getFloat(R.styleable.JJRecyclerView_cllWidthPercent,0f)
        val alsHeightPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_cllHeightPercentScreenWidth,0f)
        val alsWidthPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_cllWidthPercentScreenWidth,0f)
        val alsHeightPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_cllHeightPercentScreenHeight,0f)
        val alsWidthPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_cllWidthPercentScreenHeight,0f)

        val alsHeightResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllHeightResponsive,View.NO_ID)
        val alsWidthResponsive = a.getResourceId(R.styleable.JJRecyclerView_cllWidthResponsive,View.NO_ID)

        val alsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllHeightResponsivePercentScreenHeight,View.NO_ID)
        val alsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllWidthResponsivePercentScreenWidth,View.NO_ID)
        val alsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_cllHeightResponsivePercentScreenWidth,View.NO_ID)
        val alsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_cllWidthResponsivePercentScreenHeight,View.NO_ID)


        val attrHeightLs = a.getLayoutDimension(R.styleable.JJRecyclerView_layout_height_landscape,0)
        val attrWidthLs = a.getLayoutDimension(R.styleable.JJRecyclerView_layout_width_landscape,0)

        val llsPadding = a.getDimension(R.styleable.JJRecyclerView_lplPadding,-100f)
        val llsPaddingVertical = a.getDimension(R.styleable.JJRecyclerView_lplPaddingVertical,-100f)
        val llsPaddingHorizontal = a.getDimension(R.styleable.JJRecyclerView_lplPaddingHorizontal,-100f)
        val llsPaddingStart = a.getDimension(R.styleable.JJRecyclerView_lplPaddingStart,-100f)
        val llsPaddingEnd = a.getDimension(R.styleable.JJRecyclerView_lplPaddingEnd,-100f)
        val llsPaddingBottom = a.getDimension(R.styleable.JJRecyclerView_lplPaddingBottom,-100f)
        val llsPaddingTop = a.getDimension(R.styleable.JJRecyclerView_lplPaddingTop,-100f)

        val llsMargin = a.getDimension(R.styleable.JJRecyclerView_lplMargin,-100f)
        val llsMarginVertical = a.getDimension(R.styleable.JJRecyclerView_lplMarginVertical,-100f)
        val llsMarginHorizontal = a.getDimension(R.styleable.JJRecyclerView_lplMarginHorizontal,-100f)
        val llsMarginStart = a.getDimension(R.styleable.JJRecyclerView_lplMarginStart,-100f)
        val llsMarginEnd = a.getDimension(R.styleable.JJRecyclerView_lplMarginEnd,-100f)
        val llsMarginBottom = a.getDimension(R.styleable.JJRecyclerView_lplMarginBottom,-100f)
        val llsMarginTop = a.getDimension(R.styleable.JJRecyclerView_lplMarginTop,-100f)

        val llsHeightPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_lplHeightPercentScreenWidth,0f)
        val llsWidthPercentScreenWidth = a.getFloat(R.styleable.JJRecyclerView_lplWidthPercentScreenWidth,0f)
        val llsHeightPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_lplHeightPercentScreenHeight,0f)
        val llsWidthPercentScreenHeight = a.getFloat(R.styleable.JJRecyclerView_lplWidthPercentScreenHeight,0f)

        val llsHeightResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplHeightResponsive,View.NO_ID)
        val llsWidthResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplWidthResponsive,View.NO_ID)
        val llsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplHeightResponsivePercentScreenHeight,View.NO_ID)
        val llsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplWidthResponsivePercentScreenWidth,View.NO_ID)
        val llsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplHeightResponsivePercentScreenWidth,View.NO_ID)
        val llsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplWidthResponsivePercentScreenHeight,View.NO_ID)

        val llsMarginTopPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginTopPerScHeight,0f)
        val llsMarginLeftPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginLeftPerScHeight,0f)
        val llsMarginRightPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginRightPerScHeight,0f)
        val llsMarginBottomPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginBottomPerScHeight,0f)

        val llsMarginTopPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginTopPerScWidth,0f)
        val llsMarginLeftPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginLeftPerScWidth,0f)
        val llsMarginRightPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginRightPerScWidth,0f)
        val llsMarginBottomPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginBottomPerScWidth,0f)

        val llsMarginTopResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginTopResponsive,View.NO_ID)
        val llsMarginLeftResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginLeftResponsive,View.NO_ID)
        val llsMarginRightResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginRightResponsive,View.NO_ID)
        val llsMarginBottomResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginBottomResponsive,View.NO_ID)

        val llsMarginTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginTopResPerScWidth,View.NO_ID)
        val llsMarginLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginLeftResPerScWidth,View.NO_ID)
        val llsMarginRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginRightResPerScWidth,View.NO_ID)
        val llsMarginBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginBottomResPerScWidth,View.NO_ID)

        val llsMarginTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginTopResPerScHeight,View.NO_ID)
        val llsMarginLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginLeftResPerScHeight,View.NO_ID)
        val llsMarginRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginRightResPerScHeight,View.NO_ID)
        val llsMarginBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginBottomResPerScHeight,View.NO_ID)

        val llsMarginPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginPercentScHeight,0f)
        val llsMarginPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginPercentScWidth,0f)
        val llsMarginResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginResponsive,View.NO_ID)
        val llsMarginResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginResPerScHeight,View.NO_ID)
        val llsMarginResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginResPerScWidth,View.NO_ID)

        val llsMarginVerticalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginVerticalPerScHeight,0f)
        val llsMarginVerticalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginVerticalPerScWidth,0f)
        val llsMarginVerticalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginVerticalResponsive,View.NO_ID)
        val llsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginVerticalResPerScWidth,View.NO_ID)
        val llsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginVerticalResPerScHeight,View.NO_ID)

        val llsMarginHorizontalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lplMarginHorizontalPerScHeight,0f)
        val llsMarginHorizontalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lplMarginHorizontalPerScWidth,0f)
        val llsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplMarginHorizontalResponsive,View.NO_ID)
        val llsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplMarginHorizontalResPerScWidth,View.NO_ID)
        val llsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplMarginHorizontalResPerScHeight,View.NO_ID)


        val llsPaddingTopPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingTopPerScHeight,0f)
        val llsPaddingLeftPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingLeftPerScHeight,0f)
        val llsPaddingRightPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingRightPerScHeight,0f)
        val llsPaddingBottomPercentScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingBottomPerScHeight,0f)

        val llsPaddingTopPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingTopPerScWidth,0f)
        val llsPaddingLeftPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingLeftPerScWidth,0f)
        val llsPaddingRightPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingRightPerScWidth,0f)
        val llsPaddingBottomPercentScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingBottomPerScWidth,0f)

        val llsPaddingTopResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingTopResponsive,View.NO_ID)
        val llsPaddingLeftResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingLeftResponsive,View.NO_ID)
        val llsPaddingRightResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingRightResponsive,View.NO_ID)
        val llsPaddingBottomResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingBottomResponsive,View.NO_ID)

        val llsPaddingTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingTopResPerScWidth,View.NO_ID)
        val llsPaddingLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingLeftResPerScWidth,View.NO_ID)
        val llsPaddingRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingRightResPerScWidth,View.NO_ID)
        val llsPaddingBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingBottomResPerScWidth,View.NO_ID)

        val llsPaddingTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingTopResPerScHeight,View.NO_ID)
        val llsPaddingLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingLeftResPerScHeight,View.NO_ID)
        val llsPaddingRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingRightResPerScHeight,View.NO_ID)
        val llsPaddingBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingBottomResPerScHeight,View.NO_ID)

        val llsPaddingPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingPercentScHeight,0f)
        val llsPaddingPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingPercentScWidth,0f)
        val llsPaddingResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingResponsive,View.NO_ID)
        val llsPaddingResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingResPerScHeight,View.NO_ID)
        val llsPaddingResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingResPerScWidth,View.NO_ID)

        val llsPaddingVerticalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingVerticalPerScHeight,0f)
        val llsPaddingVerticalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingVerticalPerScWidth,0f)
        val llsPaddingVerticalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingVerticalResponsive,View.NO_ID)
        val llsPaddingVerticalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingVerticalResPerScWidth,View.NO_ID)
        val llsPaddingVerticalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingVerticalResPerScHeight,View.NO_ID)

        val llsPaddingHorizontalPerScHeight = a.getFloat(R.styleable.JJRecyclerView_lplPaddingHorizontalPerScHeight,0f)
        val llsPaddingHorizontalPerScWidth = a.getFloat(R.styleable.JJRecyclerView_lplPaddingHorizontalPerScWidth,0f)
        val llsPaddingHorizontalResponsive = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingHorizontalResponsive,View.NO_ID)
        val llsPaddingHorizontalResPerScWidth = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingHorizontalResPerScWidth,View.NO_ID)
        val llsPaddingHorizontalResPerScHeight = a.getResourceId(R.styleable.JJRecyclerView_lplPaddingHorizontalResPerScHeight,View.NO_ID)
...
//endregion
    ...
    fun rlWidth(width: Int): JJRecyclerView {
        setupRlp()
        mRlp!!.width = width
        return this
    }

    fun rlHeight(height: Int): JJRecyclerView {
        setupRlp()
        mRlp!!.height = height
        return this
    }
    ...
    fun rlMargins(margins: JJMargin): JJRecyclerView {
        setupRlp()
    ...
    fun llWidth(width: Int): JJRecyclerView {
        setupLlp()
        mLlp!!.width = width
        return this
    }

    fun llHeight(height: Int): JJRecyclerView {
        setupLlp()
        mLlp!!.height = height
        return this
    }

    fun llWeight(weigth: Float): JJRecyclerView {
        setupLlp()
        mLlp!!.weight = weigth
        return this
    }
    ...
    fun colWidth(width: Int): JJRecyclerView {
        setupCol()
        mCol!!.width = width
        return this
    }

    fun colHeight(height: Int): JJRecyclerView {
        setupCol()
        mCol!!.height = height
        return this
    }
    ...
    fun colBehavior(behavior: CoordinatorLayout.Behavior<*>) : JJRecyclerView {
        setupCol()
    ...
    fun svWidth(width: Int): JJRecyclerView {
        setupSvp()
        mSvp!!.width = width
        return this
    }

    fun svHeight(height: Int): JJRecyclerView {
        setupSvp()
        mSvp!!.height = height
        return this
    }
