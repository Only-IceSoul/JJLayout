...
class JJAppBarLayout : AppBarLayout {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs){
        ...
        mConfigurationChanged = a.getBoolean(R.styleable.JJAppBarLayout_support_configuration_changed,false)
        mSupportLandScape = a.getBoolean(R.styleable.JJAppBarLayout_support_landscape,false)
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJAppBarLayout_clMarginPerScHeight,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_clMarginPerScWidth,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJAppBarLayout_clMarginResponsive,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_clMarginResPerScHeight,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_clMarginResPerScWidth,NO_ID)
        ...
        val alsFillParent = a.getBoolean(R.styleable.JJAppBarLayout_cllFillParent,false)
        val alsFillParentHorizontal = a.getBoolean(R.styleable.JJAppBarLayout_cllFillParentHorizontally,false)
        val alsFillParentVertical = a.getBoolean(R.styleable.JJAppBarLayout_cllFillParentVertically,false)

        val alsCenterInParent = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParent,false)
        val alsCenterInParentHorizontal = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParentHorizontally,false)
        val alsCenterInParentVertical = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParentVertically,false)
        val alsCenterInParentTopVertical = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParentTopVertically,false)
        val alsCenterInParentBottomVertical = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParentBottomVertically,false)
        val alsCenterInParentStartHorizontal = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParentStartHorizontally,false)
        val alsCenterInParentEndHorizontal = a.getBoolean(R.styleable.JJAppBarLayout_cllCenterInParentEndHorizontally,false)

        val alsCenterInTopVerticalOf = a.getResourceId(R.styleable.JJAppBarLayout_cllCenterInTopVerticallyOf,View.NO_ID)
        val alsCenterInBottomVerticalOf = a.getResourceId(R.styleable.JJAppBarLayout_cllCenterInBottomVerticallyOf,View.NO_ID)
        val alsCenterInStartHorizontalOf= a.getResourceId(R.styleable.JJAppBarLayout_cllCenterInStartHorizontallyOf,View.NO_ID)
        val alsCenterInEndHorizontalOf = a.getResourceId(R.styleable.JJAppBarLayout_cllCenterInEndHorizontallyOf,View.NO_ID)

        val alsCenterVerticalOf = a.getResourceId(R.styleable.JJAppBarLayout_cllCenterVerticallyOf,View.NO_ID)
        val alsCenterHorizontalOf = a.getResourceId(R.styleable.JJAppBarLayout_cllCenterHorizontallyOf,View.NO_ID)

        val alsMarginEnd = a.getDimension(R.styleable.JJAppBarLayout_cllMarginEnd,0f)
        val alsMarginStart = a.getDimension(R.styleable.JJAppBarLayout_cllMarginStart,0f)
        val alsMarginTop = a.getDimension(R.styleable.JJAppBarLayout_cllMarginTop,0f)
        val alsMarginBottom = a.getDimension(R.styleable.JJAppBarLayout_cllMarginBottom,0f)
        val alsMarginEndPercent = a.getFloat(R.styleable.JJAppBarLayout_cllMarginEndPercentScreenHeight,0f)
        val alsMarginStartPercent = a.getFloat(R.styleable.JJAppBarLayout_cllMarginStartPercentScreenHeight,0f)
        val alsMarginTopPercent = a.getFloat(R.styleable.JJAppBarLayout_cllMarginTopPercentScreenHeight,0f)
        val alsMarginBottomPercent = a.getFloat(R.styleable.JJAppBarLayout_cllMarginBottomPercentScreenHeight,0f)
        val alsMarginEndPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginEndPercentScreenWidth,0f)
        val alsMarginStartPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginStartPercentScreenWidth,0f)
        val alsMarginTopPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginTopPercentScreenWidth,0f)
        val alsMarginBottomPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginBottomPercentScreenWidth,0f)

        val alsMargin = a.getDimension(R.styleable.JJAppBarLayout_cllMargin,0f)
        val alsMarginPercentHeight = a.getFloat(R.styleable.JJAppBarLayout_cllMarginPerScHeight,0f)
        val alsMarginPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginPerScWidth,0f)
        val alsMarginResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginResponsive,NO_ID)
        val alsMarginResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginResPerScHeight,NO_ID)
        val alsMarginResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginResPerScWidth,NO_ID)

        val alsMarginEndResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginEndResponsive,NO_ID)
        val alsMarginStartResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginStartResponsive,NO_ID)
        val alsMarginTopResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginTopResponsive,NO_ID)
        val alsMarginBottomResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginBottomResponsive,NO_ID)
        val alsMarginEndResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginEndResPerScHeight,NO_ID)
        val alsMarginStartResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginStartResPerScHeight,NO_ID)
        val alsMarginTopResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginTopResPerScHeight,NO_ID)
        val alsMarginBottomResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginBottomResPerScHeight,NO_ID)
        val alsMarginEndResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginEndResPerScWidth,NO_ID)
        val alsMarginStartResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginStartResPerScWidth,NO_ID)
        val alsMarginTopResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginTopResPerScWidth,NO_ID)
        val alsMarginBottomResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginBottomResPerScWidth,NO_ID)

        val alsMarginVertical = a.getDimension(R.styleable.JJAppBarLayout_cllMarginVertical,0f)
        val alsMarginVerticalPercentHeight = a.getFloat(R.styleable.JJAppBarLayout_cllMarginVerticalPerScHeight,0f)
        val alsMarginVerticalPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginVerticalPerScWidth,0f)
        val alsMarginVerticalResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginVerticalResponsive,NO_ID)
        val alsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginVerticalResPerScHeight,NO_ID)
        val alsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginVerticalResPerScWidth,NO_ID)

        val alsMarginHorizontal = a.getDimension(R.styleable.JJAppBarLayout_cllMarginHorizontal,0f)
        val alsMarginHorizontalPercentHeight = a.getFloat(R.styleable.JJAppBarLayout_cllMarginHorizontalPerScHeight,0f)
        val alsMarginHorizontalPercentWidth = a.getFloat(R.styleable.JJAppBarLayout_cllMarginHorizontalPerScWidth,0f)
        val alsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginHorizontalResponsive,NO_ID)
        val alsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginHorizontalResPerScHeight,NO_ID)
        val alsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllMarginHorizontalResPerScWidth,NO_ID)


        val alsVerticalBias = a.getFloat(R.styleable.JJAppBarLayout_cllVerticalBias,0.5f)
        val alsHorizontalBias = a.getFloat(R.styleable.JJAppBarLayout_cllHorizontalBias,0.5f)

        val alsStartToStartParent = a.getBoolean(R.styleable.JJAppBarLayout_cllStartToStartParent,false)
        val alsStartToEndParent = a.getBoolean(R.styleable.JJAppBarLayout_cllStartToEndParent,false)
        val alsEndToEndParent = a.getBoolean(R.styleable.JJAppBarLayout_cllEndToEndParent,false)
        val alsEndToStartParent = a.getBoolean(R.styleable.JJAppBarLayout_cllEndToStartParent,false)
        val alsTopToTopParent = a.getBoolean(R.styleable.JJAppBarLayout_cllTopToTopParent,false)
        val alsTopToBottomParent = a.getBoolean(R.styleable.JJAppBarLayout_cllTopToBottomParent,false)
        val alsBottomToBottomParent = a.getBoolean(R.styleable.JJAppBarLayout_cllBottomToBottomParent,false)
        val alsBottomToTopParent = a.getBoolean(R.styleable.JJAppBarLayout_cllBottomToTopParent,false)

        val alsStartToStartOf = a.getResourceId(R.styleable.JJAppBarLayout_cllStartToStartOf,View.NO_ID)
        val alsStartToEndOf = a.getResourceId(R.styleable.JJAppBarLayout_cllStartToEndOf,View.NO_ID)
        val alsEndToEndOf = a.getResourceId(R.styleable.JJAppBarLayout_cllEndToEndOf,View.NO_ID)
        val alsEndToStartOf = a.getResourceId(R.styleable.JJAppBarLayout_cllEndToStartOf,View.NO_ID)
        val alsTopToTopOf = a.getResourceId(R.styleable.JJAppBarLayout_cllTopToTopOf,View.NO_ID)
        val alsTopToBottomOf = a.getResourceId(R.styleable.JJAppBarLayout_cllTopToBottomOf,View.NO_ID)
        val alsBottomToBottomOf = a.getResourceId(R.styleable.JJAppBarLayout_cllBottomToBottomOf,View.NO_ID)
        val alsBottomToTopOf = a.getResourceId(R.styleable.JJAppBarLayout_cllBottomToTopOf,View.NO_ID)

        val alsHeightPercent = a.getFloat(R.styleable.JJAppBarLayout_cllHeightPercent,0f)
        val alsWidthPercent = a.getFloat(R.styleable.JJAppBarLayout_cllWidthPercent,0f)
        val alsHeightPercentScreenWidth = a.getFloat(R.styleable.JJAppBarLayout_cllHeightPercentScreenWidth,0f)
        val alsWidthPercentScreenWidth = a.getFloat(R.styleable.JJAppBarLayout_cllWidthPercentScreenWidth,0f)
        val alsHeightPercentScreenHeight = a.getFloat(R.styleable.JJAppBarLayout_cllHeightPercentScreenHeight,0f)
        val alsWidthPercentScreenHeight = a.getFloat(R.styleable.JJAppBarLayout_cllWidthPercentScreenHeight,0f)

        val alsHeightResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllHeightResponsive,View.NO_ID)
        val alsWidthResponsive = a.getResourceId(R.styleable.JJAppBarLayout_cllWidthResponsive,View.NO_ID)

        val alsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllHeightResponsivePercentScreenHeight,View.NO_ID)
        val alsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllWidthResponsivePercentScreenWidth,View.NO_ID)
        val alsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_cllHeightResponsivePercentScreenWidth,View.NO_ID)
        val alsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_cllWidthResponsivePercentScreenHeight,View.NO_ID)


        val attrHeightLs = a.getLayoutDimension(R.styleable.JJAppBarLayout_layout_height_landscape,0)
        val attrWidthLs = a.getLayoutDimension(R.styleable.JJAppBarLayout_layout_width_landscape,0)

        val llsPadding = a.getDimension(R.styleable.JJAppBarLayout_lplPadding,-100f)
        val llsPaddingVertical = a.getDimension(R.styleable.JJAppBarLayout_lplPaddingVertical,-100f)
        val llsPaddingHorizontal = a.getDimension(R.styleable.JJAppBarLayout_lplPaddingHorizontal,-100f)
        val llsPaddingStart = a.getDimension(R.styleable.JJAppBarLayout_lplPaddingStart,-100f)
        val llsPaddingEnd = a.getDimension(R.styleable.JJAppBarLayout_lplPaddingEnd,-100f)
        val llsPaddingBottom = a.getDimension(R.styleable.JJAppBarLayout_lplPaddingBottom,-100f)
        val llsPaddingTop = a.getDimension(R.styleable.JJAppBarLayout_lplPaddingTop,-100f)

        val llsMargin = a.getDimension(R.styleable.JJAppBarLayout_lplMargin,-100f)
        val llsMarginVertical = a.getDimension(R.styleable.JJAppBarLayout_lplMarginVertical,-100f)
        val llsMarginHorizontal = a.getDimension(R.styleable.JJAppBarLayout_lplMarginHorizontal,-100f)
        val llsMarginStart = a.getDimension(R.styleable.JJAppBarLayout_lplMarginStart,-100f)
        val llsMarginEnd = a.getDimension(R.styleable.JJAppBarLayout_lplMarginEnd,-100f)
        val llsMarginBottom = a.getDimension(R.styleable.JJAppBarLayout_lplMarginBottom,-100f)
        val llsMarginTop = a.getDimension(R.styleable.JJAppBarLayout_lplMarginTop,-100f)

        val llsHeightPercentScreenWidth = a.getFloat(R.styleable.JJAppBarLayout_lplHeightPercentScreenWidth,0f)
        val llsWidthPercentScreenWidth = a.getFloat(R.styleable.JJAppBarLayout_lplWidthPercentScreenWidth,0f)
        val llsHeightPercentScreenHeight = a.getFloat(R.styleable.JJAppBarLayout_lplHeightPercentScreenHeight,0f)
        val llsWidthPercentScreenHeight = a.getFloat(R.styleable.JJAppBarLayout_lplWidthPercentScreenHeight,0f)

        val llsHeightResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplHeightResponsive,View.NO_ID)
        val llsWidthResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplWidthResponsive,View.NO_ID)
        val llsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplHeightResponsivePercentScreenHeight,View.NO_ID)
        val llsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplWidthResponsivePercentScreenWidth,View.NO_ID)
        val llsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplHeightResponsivePercentScreenWidth,View.NO_ID)
        val llsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplWidthResponsivePercentScreenHeight,View.NO_ID)

        val llsMarginTopPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginTopPerScHeight,0f)
        val llsMarginLeftPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginLeftPerScHeight,0f)
        val llsMarginRightPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginRightPerScHeight,0f)
        val llsMarginBottomPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginBottomPerScHeight,0f)

        val llsMarginTopPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginTopPerScWidth,0f)
        val llsMarginLeftPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginLeftPerScWidth,0f)
        val llsMarginRightPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginRightPerScWidth,0f)
        val llsMarginBottomPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginBottomPerScWidth,0f)

        val llsMarginTopResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginTopResponsive,View.NO_ID)
        val llsMarginLeftResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginLeftResponsive,View.NO_ID)
        val llsMarginRightResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginRightResponsive,View.NO_ID)
        val llsMarginBottomResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginBottomResponsive,View.NO_ID)

        val llsMarginTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginTopResPerScWidth,View.NO_ID)
        val llsMarginLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginLeftResPerScWidth,View.NO_ID)
        val llsMarginRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginRightResPerScWidth,View.NO_ID)
        val llsMarginBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginBottomResPerScWidth,View.NO_ID)

        val llsMarginTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginTopResPerScHeight,View.NO_ID)
        val llsMarginLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginLeftResPerScHeight,View.NO_ID)
        val llsMarginRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginRightResPerScHeight,View.NO_ID)
        val llsMarginBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginBottomResPerScHeight,View.NO_ID)

        val llsMarginPerScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginPercentScHeight,0f)
        val llsMarginPerScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginPercentScWidth,0f)
        val llsMarginResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginResponsive,View.NO_ID)
        val llsMarginResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginResPerScHeight,View.NO_ID)
        val llsMarginResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginResPerScWidth,View.NO_ID)

        val llsMarginVerticalPerScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginVerticalPerScHeight,0f)
        val llsMarginVerticalPerScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginVerticalPerScWidth,0f)
        val llsMarginVerticalResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginVerticalResponsive,View.NO_ID)
        val llsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginVerticalResPerScWidth,View.NO_ID)
        val llsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginVerticalResPerScHeight,View.NO_ID)

        val llsMarginHorizontalPerScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplMarginHorizontalPerScHeight,0f)
        val llsMarginHorizontalPerScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplMarginHorizontalPerScWidth,0f)
        val llsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginHorizontalResponsive,View.NO_ID)
        val llsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginHorizontalResPerScWidth,View.NO_ID)
        val llsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplMarginHorizontalResPerScHeight,View.NO_ID)


        val llsPaddingTopPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingTopPerScHeight,0f)
        val llsPaddingLeftPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingLeftPerScHeight,0f)
        val llsPaddingRightPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingRightPerScHeight,0f)
        val llsPaddingBottomPercentScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingBottomPerScHeight,0f)

        val llsPaddingTopPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingTopPerScWidth,0f)
        val llsPaddingLeftPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingLeftPerScWidth,0f)
        val llsPaddingRightPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingRightPerScWidth,0f)
        val llsPaddingBottomPercentScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingBottomPerScWidth,0f)

        val llsPaddingTopResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingTopResponsive,View.NO_ID)
        val llsPaddingLeftResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingLeftResponsive,View.NO_ID)
        val llsPaddingRightResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingRightResponsive,View.NO_ID)
        val llsPaddingBottomResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingBottomResponsive,View.NO_ID)

        val llsPaddingTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingTopResPerScWidth,View.NO_ID)
        val llsPaddingLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingLeftResPerScWidth,View.NO_ID)
        val llsPaddingRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingRightResPerScWidth,View.NO_ID)
        val llsPaddingBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingBottomResPerScWidth,View.NO_ID)

        val llsPaddingTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingTopResPerScHeight,View.NO_ID)
        val llsPaddingLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingLeftResPerScHeight,View.NO_ID)
        val llsPaddingRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingRightResPerScHeight,View.NO_ID)
        val llsPaddingBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingBottomResPerScHeight,View.NO_ID)

        val llsPaddingPerScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingPercentScHeight,0f)
        val llsPaddingPerScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingPercentScWidth,0f)
        val llsPaddingResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingResponsive,View.NO_ID)
        val llsPaddingResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingResPerScHeight,View.NO_ID)
        val llsPaddingResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingResPerScWidth,View.NO_ID)

        val llsPaddingVerticalPerScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingVerticalPerScHeight,0f)
        val llsPaddingVerticalPerScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingVerticalPerScWidth,0f)
        val llsPaddingVerticalResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingVerticalResponsive,View.NO_ID)
        val llsPaddingVerticalResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingVerticalResPerScWidth,View.NO_ID)
        val llsPaddingVerticalResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingVerticalResPerScHeight,View.NO_ID)

        val llsPaddingHorizontalPerScHeight = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingHorizontalPerScHeight,0f)
        val llsPaddingHorizontalPerScWidth = a.getFloat(R.styleable.JJAppBarLayout_lplPaddingHorizontalPerScWidth,0f)
        val llsPaddingHorizontalResponsive = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingHorizontalResponsive,View.NO_ID)
        val llsPaddingHorizontalResPerScWidth = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingHorizontalResPerScWidth,View.NO_ID)
        val llsPaddingHorizontalResPerScHeight = a.getResourceId(R.styleable.JJAppBarLayout_lplPaddingHorizontalResPerScHeight,View.NO_ID)
