...
class JJViewPager : ViewPager {
    ...
    constructor(context: Context, attrs: AttributeSet?):super(context,attrs){
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJViewPager_clMargin,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJViewPager_clMargin,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJViewPager_clMargin,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJViewPager_clMargin,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJViewPager_clMargin,NO_ID)
