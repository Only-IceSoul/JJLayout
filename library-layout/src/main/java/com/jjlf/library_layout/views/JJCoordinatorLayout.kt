...
open class JJCoordinatorLayout : CoordinatorLayout {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs){
        ...
        mSupportLandScape = a.getBoolean(R.styleable.JJCoordinatorLayout_support_landscape,false)
        mConfigurationChanged = a.getBoolean(R.styleable.JJCoordinatorLayout_support_configuration_changed,false)
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJCoordinatorLayout_clMarginPerScHeight,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_clMarginPerScWidth,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_clMarginResponsive,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_clMarginResPerScHeight,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_clMarginResPerScWidth,NO_ID)
        ...
        val alsFillParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllFillParent,false)
        val alsFillParentHorizontal = a.getBoolean(R.styleable.JJCoordinatorLayout_cllFillParentHorizontally,false)
        val alsFillParentVertical = a.getBoolean(R.styleable.JJCoordinatorLayout_cllFillParentVertically,false)

        val alsCenterInParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParent,false)
        val alsCenterInParentHorizontal = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParentHorizontally,false)
        val alsCenterInParentVertical = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParentVertically,false)
        val alsCenterInParentTopVertical = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParentTopVertically,false)
        val alsCenterInParentBottomVertical = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParentBottomVertically,false)
        val alsCenterInParentStartHorizontal = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParentStartHorizontally,false)
        val alsCenterInParentEndHorizontal = a.getBoolean(R.styleable.JJCoordinatorLayout_cllCenterInParentEndHorizontally,false)

        val alsCenterInTopVerticalOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllCenterInTopVerticallyOf,View.NO_ID)
        val alsCenterInBottomVerticalOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllCenterInBottomVerticallyOf,View.NO_ID)
        val alsCenterInStartHorizontalOf= a.getResourceId(R.styleable.JJCoordinatorLayout_cllCenterInStartHorizontallyOf,View.NO_ID)
        val alsCenterInEndHorizontalOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllCenterInEndHorizontallyOf,View.NO_ID)

        val alsCenterVerticalOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllCenterVerticallyOf,View.NO_ID)
        val alsCenterHorizontalOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllCenterHorizontallyOf,View.NO_ID)

        val alsMarginEnd = a.getDimension(R.styleable.JJCoordinatorLayout_cllMarginEnd,0f)
        val alsMarginStart = a.getDimension(R.styleable.JJCoordinatorLayout_cllMarginStart,0f)
        val alsMarginTop = a.getDimension(R.styleable.JJCoordinatorLayout_cllMarginTop,0f)
        val alsMarginBottom = a.getDimension(R.styleable.JJCoordinatorLayout_cllMarginBottom,0f)
        val alsMarginEndPercent = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginEndPercentScreenHeight,0f)
        val alsMarginStartPercent = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginStartPercentScreenHeight,0f)
        val alsMarginTopPercent = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginTopPercentScreenHeight,0f)
        val alsMarginBottomPercent = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginBottomPercentScreenHeight,0f)
        val alsMarginEndPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginEndPercentScreenWidth,0f)
        val alsMarginStartPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginStartPercentScreenWidth,0f)
        val alsMarginTopPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginTopPercentScreenWidth,0f)
        val alsMarginBottomPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginBottomPercentScreenWidth,0f)

        val alsMargin = a.getDimension(R.styleable.JJCoordinatorLayout_cllMargin,0f)
        val alsMarginPercentHeight = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginPerScHeight,0f)
        val alsMarginPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginPerScWidth,0f)
        val alsMarginResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginResponsive,NO_ID)
        val alsMarginResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginResPerScHeight,NO_ID)
        val alsMarginResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginResPerScWidth,NO_ID)

        val alsMarginEndResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginEndResponsive,NO_ID)
        val alsMarginStartResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginStartResponsive,NO_ID)
        val alsMarginTopResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginTopResponsive,NO_ID)
        val alsMarginBottomResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginBottomResponsive,NO_ID)
        val alsMarginEndResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginEndResPerScHeight,NO_ID)
        val alsMarginStartResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginStartResPerScHeight,NO_ID)
        val alsMarginTopResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginTopResPerScHeight,NO_ID)
        val alsMarginBottomResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginBottomResPerScHeight,NO_ID)
        val alsMarginEndResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginEndResPerScWidth,NO_ID)
        val alsMarginStartResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginStartResPerScWidth,NO_ID)
        val alsMarginTopResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginTopResPerScWidth,NO_ID)
        val alsMarginBottomResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginBottomResPerScWidth,NO_ID)

        val alsMarginVertical = a.getDimension(R.styleable.JJCoordinatorLayout_cllMarginVertical,0f)
        val alsMarginVerticalPercentHeight = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginVerticalPerScHeight,0f)
        val alsMarginVerticalPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginVerticalPerScWidth,0f)
        val alsMarginVerticalResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginVerticalResponsive,NO_ID)
        val alsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginVerticalResPerScHeight,NO_ID)
        val alsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginVerticalResPerScWidth,NO_ID)

        val alsMarginHorizontal = a.getDimension(R.styleable.JJCoordinatorLayout_cllMarginHorizontal,0f)
        val alsMarginHorizontalPercentHeight = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginHorizontalPerScHeight,0f)
        val alsMarginHorizontalPercentWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllMarginHorizontalPerScWidth,0f)
        val alsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginHorizontalResponsive,NO_ID)
        val alsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginHorizontalResPerScHeight,NO_ID)
        val alsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllMarginHorizontalResPerScWidth,NO_ID)


        val alsVerticalBias = a.getFloat(R.styleable.JJCoordinatorLayout_cllVerticalBias,0.5f)
        val alsHorizontalBias = a.getFloat(R.styleable.JJCoordinatorLayout_cllHorizontalBias,0.5f)

        val alsStartToStartParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllStartToStartParent,false)
        val alsStartToEndParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllStartToEndParent,false)
        val alsEndToEndParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllEndToEndParent,false)
        val alsEndToStartParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllEndToStartParent,false)
        val alsTopToTopParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllTopToTopParent,false)
        val alsTopToBottomParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllTopToBottomParent,false)
        val alsBottomToBottomParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllBottomToBottomParent,false)
        val alsBottomToTopParent = a.getBoolean(R.styleable.JJCoordinatorLayout_cllBottomToTopParent,false)

        val alsStartToStartOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllStartToStartOf,View.NO_ID)
        val alsStartToEndOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllStartToEndOf,View.NO_ID)
        val alsEndToEndOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllEndToEndOf,View.NO_ID)
        val alsEndToStartOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllEndToStartOf,View.NO_ID)
        val alsTopToTopOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllTopToTopOf,View.NO_ID)
        val alsTopToBottomOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllTopToBottomOf,View.NO_ID)
        val alsBottomToBottomOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllBottomToBottomOf,View.NO_ID)
        val alsBottomToTopOf = a.getResourceId(R.styleable.JJCoordinatorLayout_cllBottomToTopOf,View.NO_ID)

        val alsHeightPercent = a.getFloat(R.styleable.JJCoordinatorLayout_cllHeightPercent,0f)
        val alsWidthPercent = a.getFloat(R.styleable.JJCoordinatorLayout_cllWidthPercent,0f)
        val alsHeightPercentScreenWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllHeightPercentScreenWidth,0f)
        val alsWidthPercentScreenWidth = a.getFloat(R.styleable.JJCoordinatorLayout_cllWidthPercentScreenWidth,0f)
        val alsHeightPercentScreenHeight = a.getFloat(R.styleable.JJCoordinatorLayout_cllHeightPercentScreenHeight,0f)
        val alsWidthPercentScreenHeight = a.getFloat(R.styleable.JJCoordinatorLayout_cllWidthPercentScreenHeight,0f)

        val alsHeightResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllHeightResponsive,View.NO_ID)
        val alsWidthResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_cllWidthResponsive,View.NO_ID)

        val alsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllHeightResponsivePercentScreenHeight,View.NO_ID)
        val alsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllWidthResponsivePercentScreenWidth,View.NO_ID)
        val alsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_cllHeightResponsivePercentScreenWidth,View.NO_ID)
        val alsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_cllWidthResponsivePercentScreenHeight,View.NO_ID)


        val attrHeightLs = a.getLayoutDimension(R.styleable.JJCoordinatorLayout_layout_height_landscape,0)
        val attrWidthLs = a.getLayoutDimension(R.styleable.JJCoordinatorLayout_layout_width_landscape,0)

        val llsPadding = a.getDimension(R.styleable.JJCoordinatorLayout_lplPadding,-100f)
        val llsPaddingVertical = a.getDimension(R.styleable.JJCoordinatorLayout_lplPaddingVertical,-100f)
        val llsPaddingHorizontal = a.getDimension(R.styleable.JJCoordinatorLayout_lplPaddingHorizontal,-100f)
        val llsPaddingStart = a.getDimension(R.styleable.JJCoordinatorLayout_lplPaddingStart,-100f)
        val llsPaddingEnd = a.getDimension(R.styleable.JJCoordinatorLayout_lplPaddingEnd,-100f)
        val llsPaddingBottom = a.getDimension(R.styleable.JJCoordinatorLayout_lplPaddingBottom,-100f)
        val llsPaddingTop = a.getDimension(R.styleable.JJCoordinatorLayout_lplPaddingTop,-100f)

        val llsMargin = a.getDimension(R.styleable.JJCoordinatorLayout_lplMargin,-100f)
        val llsMarginVertical = a.getDimension(R.styleable.JJCoordinatorLayout_lplMarginVertical,-100f)
        val llsMarginHorizontal = a.getDimension(R.styleable.JJCoordinatorLayout_lplMarginHorizontal,-100f)
        val llsMarginStart = a.getDimension(R.styleable.JJCoordinatorLayout_lplMarginStart,-100f)
        val llsMarginEnd = a.getDimension(R.styleable.JJCoordinatorLayout_lplMarginEnd,-100f)
        val llsMarginBottom = a.getDimension(R.styleable.JJCoordinatorLayout_lplMarginBottom,-100f)
        val llsMarginTop = a.getDimension(R.styleable.JJCoordinatorLayout_lplMarginTop,-100f)

        val llsHeightPercentScreenWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplHeightPercentScreenWidth,0f)
        val llsWidthPercentScreenWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplWidthPercentScreenWidth,0f)
        val llsHeightPercentScreenHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplHeightPercentScreenHeight,0f)
        val llsWidthPercentScreenHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplWidthPercentScreenHeight,0f)

        val llsHeightResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplHeightResponsive,View.NO_ID)
        val llsWidthResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplWidthResponsive,View.NO_ID)
        val llsHeightResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplHeightResponsivePercentScreenHeight,View.NO_ID)
        val llsWidthResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplWidthResponsivePercentScreenWidth,View.NO_ID)
        val llsHeightResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplHeightResponsivePercentScreenWidth,View.NO_ID)
        val llsWidthResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplWidthResponsivePercentScreenHeight,View.NO_ID)

        val llsMarginTopPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginTopPerScHeight,0f)
        val llsMarginLeftPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginLeftPerScHeight,0f)
        val llsMarginRightPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginRightPerScHeight,0f)
        val llsMarginBottomPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginBottomPerScHeight,0f)

        val llsMarginTopPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginTopPerScWidth,0f)
        val llsMarginLeftPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginLeftPerScWidth,0f)
        val llsMarginRightPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginRightPerScWidth,0f)
        val llsMarginBottomPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginBottomPerScWidth,0f)

        val llsMarginTopResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginTopResponsive,View.NO_ID)
        val llsMarginLeftResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginLeftResponsive,View.NO_ID)
        val llsMarginRightResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginRightResponsive,View.NO_ID)
        val llsMarginBottomResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginBottomResponsive,View.NO_ID)

        val llsMarginTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginTopResPerScWidth,View.NO_ID)
        val llsMarginLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginLeftResPerScWidth,View.NO_ID)
        val llsMarginRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginRightResPerScWidth,View.NO_ID)
        val llsMarginBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginBottomResPerScWidth,View.NO_ID)

        val llsMarginTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginTopResPerScHeight,View.NO_ID)
        val llsMarginLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginLeftResPerScHeight,View.NO_ID)
        val llsMarginRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginRightResPerScHeight,View.NO_ID)
        val llsMarginBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginBottomResPerScHeight,View.NO_ID)

        val llsMarginPerScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginPercentScHeight,0f)
        val llsMarginPerScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginPercentScWidth,0f)
        val llsMarginResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginResponsive,View.NO_ID)
        val llsMarginResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginResPerScHeight,View.NO_ID)
        val llsMarginResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginResPerScWidth,View.NO_ID)

        val llsMarginVerticalPerScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginVerticalPerScHeight,0f)
        val llsMarginVerticalPerScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginVerticalPerScWidth,0f)
        val llsMarginVerticalResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginVerticalResponsive,View.NO_ID)
        val llsMarginVerticalResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginVerticalResPerScWidth,View.NO_ID)
        val llsMarginVerticalResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginVerticalResPerScHeight,View.NO_ID)

        val llsMarginHorizontalPerScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginHorizontalPerScHeight,0f)
        val llsMarginHorizontalPerScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplMarginHorizontalPerScWidth,0f)
        val llsMarginHorizontalResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginHorizontalResponsive,View.NO_ID)
        val llsMarginHorizontalResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginHorizontalResPerScWidth,View.NO_ID)
        val llsMarginHorizontalResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplMarginHorizontalResPerScHeight,View.NO_ID)


        val llsPaddingTopPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingTopPerScHeight,0f)
        val llsPaddingLeftPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingLeftPerScHeight,0f)
        val llsPaddingRightPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingRightPerScHeight,0f)
        val llsPaddingBottomPercentScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingBottomPerScHeight,0f)

        val llsPaddingTopPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingTopPerScWidth,0f)
        val llsPaddingLeftPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingLeftPerScWidth,0f)
        val llsPaddingRightPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingRightPerScWidth,0f)
        val llsPaddingBottomPercentScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingBottomPerScWidth,0f)

        val llsPaddingTopResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingTopResponsive,View.NO_ID)
        val llsPaddingLeftResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingLeftResponsive,View.NO_ID)
        val llsPaddingRightResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingRightResponsive,View.NO_ID)
        val llsPaddingBottomResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingBottomResponsive,View.NO_ID)

        val llsPaddingTopResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingTopResPerScWidth,View.NO_ID)
        val llsPaddingLeftResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingLeftResPerScWidth,View.NO_ID)
        val llsPaddingRightResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingRightResPerScWidth,View.NO_ID)
        val llsPaddingBottomResponsivePercentScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingBottomResPerScWidth,View.NO_ID)

        val llsPaddingTopResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingTopResPerScHeight,View.NO_ID)
        val llsPaddingLeftResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingLeftResPerScHeight,View.NO_ID)
        val llsPaddingRightResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingRightResPerScHeight,View.NO_ID)
        val llsPaddingBottomResponsivePercentScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingBottomResPerScHeight,View.NO_ID)

        val llsPaddingPerScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingPercentScHeight,0f)
        val llsPaddingPerScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingPercentScWidth,0f)
        val llsPaddingResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingResponsive,View.NO_ID)
        val llsPaddingResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingResPerScHeight,View.NO_ID)
        val llsPaddingResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingResPerScWidth,View.NO_ID)

        val llsPaddingVerticalPerScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingVerticalPerScHeight,0f)
        val llsPaddingVerticalPerScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingVerticalPerScWidth,0f)
        val llsPaddingVerticalResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingVerticalResponsive,View.NO_ID)
        val llsPaddingVerticalResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingVerticalResPerScWidth,View.NO_ID)
        val llsPaddingVerticalResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingVerticalResPerScHeight,View.NO_ID)

        val llsPaddingHorizontalPerScHeight = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingHorizontalPerScHeight,0f)
        val llsPaddingHorizontalPerScWidth = a.getFloat(R.styleable.JJCoordinatorLayout_lplPaddingHorizontalPerScWidth,0f)
        val llsPaddingHorizontalResponsive = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingHorizontalResponsive,View.NO_ID)
        val llsPaddingHorizontalResPerScWidth = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingHorizontalResPerScWidth,View.NO_ID)
        val llsPaddingHorizontalResPerScHeight = a.getResourceId(R.styleable.JJCoordinatorLayout_lplPaddingHorizontalResPerScHeight,View.NO_ID)
