...
class JJImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs){
        ...
        val aMarginPercentHeight = a.getFloat(R.styleable.JJImageView_clMargin,0f)
        val aMarginPercentWidth = a.getFloat(R.styleable.JJImageView_clMargin,0f)
        val aMarginResponsive = a.getResourceId(R.styleable.JJImageView_clMargin,NO_ID)
        val aMarginResPerScHeight = a.getResourceId(R.styleable.JJImageView_clMargin,NO_ID)
        val aMarginResPerScWidth = a.getResourceId(R.styleable.JJImageView_clMargin,NO_ID)
