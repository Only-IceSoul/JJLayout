...
//endregion
    ...
    fun colGravity(gravity: Int): JJRelativeLayout {
        setupCol()
    ...
    fun ablScrollFlags(flags: Int) : JJRelativeLayout {
        setupAblp()
        (layoutParams as? AppBarLayout.LayoutParams)?.scrollFlags = flags
        return this
    }

    fun ablScrollInterpolator(interpolator: Interpolator) : JJRelativeLayout {
        setupAblp()
    ...
    fun rlAlignParentTop(value : Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentStart(value : Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentEnd(value : Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentLeft(value : Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignParentRight(value : Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentVertically(value:Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlCenterInParentHorizontally(value:Boolean = true): JJRelativeLayout {
        setupRlp()
        val data = if(value) 1 else 0
    ...
    fun rlAlignBaseline(viewId: Int): JJRelativeLayout {
        setupRlp()
    ...
    fun llWeight(w: Float): JJRelativeLayout {
        setupLlp()
