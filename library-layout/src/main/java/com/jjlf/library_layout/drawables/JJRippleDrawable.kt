package com.jjlf.jjkit.drawables
...
class JJRippleDrawable(color: ColorStateList,
    ...
    companion object{
        fun roundRect(colorBg: Int, radius: Float = 0f, colorPressed: Int = 0 , colorRipple: Int = Color.parseColor("#80CCCCCC"), strokeW: Float = 0f, colorStroke: Int = Color.BLACK): RippleDrawable {
            ...
            val colorState = ColorStateList(arrayOf(intArrayOf(android.R.attr.state_pressed) ,intArrayOf(-android.R.attr.state_pressed)), intArrayOf(colorPressed,colorRip))
